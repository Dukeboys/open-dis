    ...
    */
    ...
    public JavaGenerator(HashMap pClassDescriptions, Properties pJavaProperties)
    {
        ...
        try
        {
            ...
            super.setDirectory(pJavaProperties.getProperty("directory"));
         ...
         if(aClass.getClassComments() != null)
          {
              ...
              pw.println(" *");
              pw.println(" * Copyright (c) 2008-2010, MOVES Institute, Naval Postgraduate School. All rights reserved.");
