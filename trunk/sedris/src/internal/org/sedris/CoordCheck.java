...
abstract class CoordCheck
{
    ...
    private static SRM_SRFT_Code[] srftBoundaryDefTemplate =
    {
        ...
        SRM_SRFT_Code.SRFT_LOCOCENTRIC_EUCLIDEAN_3D,
    ...
    ) throws SrmException
    {
        ...
        if (region == null ||
            region.type == SRM_Interval_Type.UNBOUNDED)
        {
        ...
        else if (region.type == SRM_Interval_Type.GE_LT ||
                 region.type == SRM_Interval_Type.GE_SEMI ||
        ...
        else if (region.type == SRM_Interval_Type.GT_LE ||
                 region.type == SRM_Interval_Type.GT_SEMI ||
    ...
    ) throws SrmException
    {
        ...
        if (reg[0]==SRM_Coordinate_Valid_Region_Code.VALID &&
            reg[1]==SRM_Coordinate_Valid_Region_Code.VALID)
        {
            ret_reg = SRM_Coordinate_Valid_Region_Code.VALID;
        }
        else if (reg[0]==SRM_Coordinate_Valid_Region_Code.DEFINED ||
                 reg[1]==SRM_Coordinate_Valid_Region_Code.DEFINED)
        {
            ret_reg = SRM_Coordinate_Valid_Region_Code.DEFINED;
        }
        else
    ...
    ) throws SrmException
    {
        ...
        if (reg[0]==SRM_Coordinate_Valid_Region_Code.VALID &&
            reg[1]==SRM_Coordinate_Valid_Region_Code.VALID &&
            reg[2]==SRM_Coordinate_Valid_Region_Code.VALID)
        {
            ret_reg = SRM_Coordinate_Valid_Region_Code.VALID;
        }
        else if (reg[0]==SRM_Coordinate_Valid_Region_Code.DEFINED ||
                 reg[1]==SRM_Coordinate_Valid_Region_Code.DEFINED ||
                 reg[2]==SRM_Coordinate_Valid_Region_Code.DEFINED)
        {
            ret_reg = SRM_Coordinate_Valid_Region_Code.DEFINED;
        }
        else
    ...
    */
    ...
    ) throws SrmException
    {
        ...
        if (member == SRM_SRFSM_Lambert_NTF_Code.SRFSMLAMNTF_ZONE_I)
        {
        ...
        else if (member == SRM_SRFSM_Lambert_NTF_Code.SRFSMLAMNTF_ZONE_II)
        {
            if ((coord[0] >= -5.0*Const.RADIANS_PER_DEGREE)&&
                (coord[0] <= 10.0*Const.RADIANS_PER_DEGREE)&&
        ...
        else if (member == SRM_SRFSM_Lambert_NTF_Code.SRFSMLAMNTF_ZONE_III)
        {
            if ((coord[0] >= -5.0*Const.RADIANS_PER_DEGREE)&&
                (coord[0] <= 10.0*Const.RADIANS_PER_DEGREE)&&
        ...
        else if (member == SRM_SRFSM_Lambert_NTF_Code.SRFSMLAMNTF_ZONE_IV)
        {
    ...
    (
        OrmData                   ormData,
        SRM_SRFSM_Japan_RPCS_Code member,
        SRF_TM_Params             params,
        double[]                  coord
    ) throws SrmException
    {
        ...
        switch (member.toInt())
        {
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_I:
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_II:
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_III:
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_IV:
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_V:
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_VI:
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_VII:
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_VIII:
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_IX:
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_X:
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_XI:
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_XII:
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_XIII:
                 ...
                 break;
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_XIV:
                 ...
                 break;
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_XV:
                 ...
                 break;
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_XVI:
                 if (coord[0] > 126.0*Const.RADIANS_PER_DEGREE)
                 {
                     status = forTransverseMercator_cd(ormData, params, coord);
                 }
                 ...
                 break;
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_XVII:
                 ...
                 break;
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_XVIII:
                 if ((coord[0] > 140.5*Const.RADIANS_PER_DEGREE)
                  && (coord[1] < 28.0*Const.RADIANS_PER_DEGREE))
                 {
                     status = forTransverseMercator_cd(ormData, params, coord);
                 ...
                 break;
            case SRM_SRFSM_Japan_RPCS_Code._SRFSMJPRPCS_ZONE_XIX:
