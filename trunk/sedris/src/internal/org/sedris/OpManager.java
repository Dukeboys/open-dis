...
public class OpManager
{
    ...
    ) throws SrmException
    {
        ...
        { // this case is the case for user supplied xformation params.
            ...
            {
                Vector path = Bfs.instance().GetConversionPath
        ...
        else
        {
            ...
            Vector path1 = Bfs.instance().GetConversionPath
                           (srcSrf.getSRFTemplateCode(),
            ...
            Vector path2 = Bfs.instance().GetConversionPath
                           (SRM_SRFT_Code.SRFT_CELESTIOCENTRIC,
                            tgtSrf.getSRFTemplateCode());
            if (path2 == null)
            {
                       ...
                       SRM_ORM_Trans_Params hst) throws SrmException
    {
        ...
        // reject the conversion if one RT is UNDEFINED and the other is not.
        if ((srcSrf.getOrm() != tgtSrf.getOrm()) && hst == null &&
            (srcSrf.getRt() == SRM_RT_Code.RT_UNDEFINED ||
             tgtSrf.getRt() == SRM_RT_Code.RT_UNDEFINED))
