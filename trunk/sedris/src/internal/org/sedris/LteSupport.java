...
class LteSupport
{
    ...
    protected static SRF_LocalTangentSpaceEuclidean createLtesSRF(BaseSRF  srf_org,
	...
	cd_srf_obj = new SRF_Celestiodetic ( srf_org.get_orm(),
					     srf_org.get_rt() );
	...
	return new SRF_LocalTangentSpaceEuclidean( srf_org.get_orm(), srf_org.get_rt(),  my_3D_tgt[0],
