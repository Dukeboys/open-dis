 ...
 */
    ...
    ) throws SrmException
    {
        SRM_Coordinate_Valid_Region_Code retValid =
            SRM_Coordinate_Valid_Region_Code.VALID;

        switch (destSrfType.toInt())
        {
            case SRM_SRFT_Code._SRFT_CELESTIOCENTRIC:
            {
            ...
            case SRM_SRFT_Code._SRFT_TRANSVERSE_MERCATOR:
            {
                // perform pre validation
                switch ((destSrf.getSRFSetCode()).toInt())
                {
                    case SRM_SRFS_Code._SRFS_ALABAMA_SPCS:
            ...
            case SRM_SRFT_Code._SRFT_MERCATOR:
            {
                // perform pre validation
                retValid = CoordCheck.forCelestiodetic(this.getOrmData(), src);
            ...
            case SRM_SRFT_Code._SRFT_LAMBERT_CONFORMAL_CONIC:
            {
                // perform pre validation
                retValid = CoordCheck.forCelestiodetic(this.getOrmData(), src);
            ...
            case SRM_SRFT_Code._SRFT_PLANETODETIC:
            {
                // perform pre validation
                retValid = CoordCheck.forCelestiodetic(this.getOrmData(), src);
            ...
            case SRM_SRFT_Code._SRFT_OBLIQUE_MERCATOR_SPHERICAL:
            {
            ...
            case SRM_SRFT_Code._SRFT_EQUIDISTANT_CYLINDRICAL:
            {
                // perform pre validation
            ...
            case SRM_SRFT_Code._SRFT_POLAR_STEREOGRAPHIC:
            {
                // perform pre validation
                // use UPS validation if destination SRF is UPS
                if (destSrf.getSRFSetCode() ==
                    SRM_SRFS_Code.SRFS_UNIVERSAL_POLAR_STEREOGRAPHIC)
                {
            ...
            case SRM_SRFT_Code._SRFT_UNDEFINED:
            {
