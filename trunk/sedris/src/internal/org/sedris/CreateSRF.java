...
public class CreateSRF
{
	...
	if (srf_code == SRM_SRF_Code.SRF_BRITISH_NATIONAL_GRID_AIRY) 
	    {
		if ( Const.isValidOrmRt( SRM_ORM_Code.ORM_OSGB_1936, rt_code ) )
		    ...
		    throw new SrmException( SrmException._INVALID_CODE, 
					    new String("createStandardSRF: incompatble RT with ORM_OSGB_1936") );  
	    }
	else if (srf_code == SRM_SRF_Code.SRF_BRITISH_OSGRS80_GRID)
	    {
		if ( Const.isValidOrmRt( SRM_ORM_Code.ORM_ETRS_1989, rt_code ) )
		    ...
		    throw new SrmException( SrmException._INVALID_CODE, 
					    new String("createStandardSRF: incompatble RT with ORM_ETRS_1989") );  
	    }
	else if (srf_code == SRM_SRF_Code.SRF_DELAWARE_SPCS_1983)
	    {
		if ( Const.isValidOrmRt( SRM_ORM_Code.ORM_N_AM_1983, rt_code ) )
		    ...
		    throw new SrmException( SrmException._INVALID_CODE, 
					    new String("createStandardSRF: incompatble RT with ORM_N_AM_1983") );  
	    }	
	else if (srf_code == SRM_SRF_Code.SRF_GEOCENTRIC_WGS_1984)
	    {
		if ( Const.isValidOrmRt( SRM_ORM_Code.ORM_WGS_1984, rt_code ) )
		    retSRF = new SRF_Celestiocentric (SRM_ORM_Code.ORM_WGS_1984, rt_code );
		else
		    throw new SrmException( SrmException._INVALID_CODE, 
					    new String("createStandardSRF: incompatble RT with ORM_WGS_1984") );  
	    }
	else if (srf_code == SRM_SRF_Code.SRF_GEODETIC_AUSTRALIA_1984)
	    {
		if ( Const.isValidOrmRt( SRM_ORM_Code.ORM_AUSTRALIAN_GEOD_1984, rt_code ) )
		    retSRF = new SRF_Celestiodetic (SRM_ORM_Code.ORM_AUSTRALIAN_GEOD_1984,
						    rt_code );
		else
		    throw new SrmException( SrmException._INVALID_CODE, 
					    new String("createStandardSRF: incompatble RT with ORM_AUSTRALIAN_GEOD_1984") );  
	    }
	else if (srf_code == SRM_SRF_Code.SRF_GEODETIC_WGS_1984)
	    {
		if ( Const.isValidOrmRt( SRM_ORM_Code.ORM_WGS_1984, rt_code ) )
		    retSRF = new SRF_Celestiodetic (SRM_ORM_Code.ORM_WGS_1984, rt_code );
		else
		    throw new SrmException( SrmException._INVALID_CODE, 
					    new String("createStandardSRF: incompatble RT with ORM_WGS_1984") );  
	    }
	    ...
	    {
		if ( Const.isValidOrmRt( SRM_ORM_Code.ORM_N_AM_1983, rt_code ) )
		    retSRF = new SRF_Celestiodetic (SRM_ORM_Code.ORM_N_AM_1983, rt_code );
		else
		    throw new SrmException( SrmException._INVALID_CODE, 
					    new String("createStandardSRF: incompatble RT with ORM_N_AM_1983") );  
	    }
	    ...
	    {
		if ( Const.isValidOrmRt( SRM_ORM_Code.ORM_IRELAND_1965, rt_code ) )
		    ...
		    throw new SrmException( SrmException._INVALID_CODE, 
					    new String("createStandardSRF: incompatble RT with ORM_IRELAND_1965") );  
	    }
	...
	else if (srf_code == SRM_SRF_Code.SRF_LAMBERT_93)
	    {
		if ( Const.isValidOrmRt( SRM_ORM_Code.ORM_RGF_1993, rt_code ) )
		    ...
		    throw new SrmException( SrmException._INVALID_CODE, 
					    new String("createStandardSRF: incompatble RT with ORM_RGF_1993") );  
	    }
	else if (srf_code == SRM_SRF_Code.SRF_LAMBERT_II_WIDE)
	    {
		if ( Const.isValidOrmRt( SRM_ORM_Code.ORM_NTF_1896_PM_PARIS, rt_code ) )
		    ...
		    throw new SrmException( SrmException._INVALID_CODE, 
					    new String("createStandardSRF: incompatble RT with ORM_NTF_1896_PM_PARIS") );  
	    }
	    ...
	    {
		if ( Const.isValidOrmRt( SRM_ORM_Code.ORM_MARS_SPHERE_2000, rt_code ) )
		    retSRF = new SRF_Celestiodetic(SRM_ORM_Code.ORM_MARS_SPHERE_2000,
						   rt_code);
		else
		    throw new SrmException( SrmException._INVALID_CODE, 
					    new String("createStandardSRF: incompatble RT with ORM_MARS_SPHERE_2000") );  
	    }
	else if (srf_code == SRM_SRF_Code.SRF_MARS_PLANETOGRAPHIC_2000)
	    {
		if ( Const.isValidOrmRt( SRM_ORM_Code.ORM_MARS_2000, rt_code ) )
		    retSRF = new SRF_Planetodetic(SRM_ORM_Code.ORM_MARS_2000,
						  rt_code);
		else
		    throw new SrmException( SrmException._INVALID_CODE, 
					    new String("createStandardSRF: incompatble RT with ORM_MARS_2000") );  
	    }
	...
	else if (srf_set == SRM_SRFS_Code.SRFS_JAPAN_RECTANGULAR_PLANE_CS) {
	    if ( set_member instanceof SRM_SRFSM_Japan_RPCS_Code ) {
	...
	if ( orm != SRM_ORM_Code.ORM_N_AM_1983 || rt != SRM_RT_Code.RT_N_AM_1983_CONTINENTAL_US )
	    throw new SrmException( SrmException._INVALID_CODE, 
				    new String("createSRFSetMember: invalid Alabama SPCS SRF ORM code") );
	    
	// ASPCS_WEST_ZONE
	if ( set_member == SRM_SRFSM_Alabama_SPCS_Code.SRFSMAL_WEST_ZONE)
	    retSRF = new SRF_TransverseMercator(orm,
						...
						0.0 );  //false_northing
	//ASPCS_EAST_ZONE	
	else if ( set_member == SRM_SRFSM_Alabama_SPCS_Code.SRFSMAL_EAST_ZONE)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
	...
	if ( orm != SRM_ORM_Code.ORM_WGS_1984 || rt != SRM_RT_Code.RT_WGS_1984_IDENTITY )
	    throw new SrmException( SrmException._INVALID_CODE, 
	...
	retSRF = new SRF_LocalTangentSpaceEuclidean(orm,
						    rt,
	...
	if ( orm != SRM_ORM_Code.ORM_NTF_1896 || rt != SRM_RT_Code.RT_NTF_1896_FRANCE )
	    throw new SrmException( SrmException._INVALID_CODE, 
				    new String("createSRFSetMember: invalid Lambert NTF SRF ORM code") );
	    
	// LNTF_ZONE_I
	if ( set_member == SRM_SRFSM_Lambert_NTF_Code.SRFSMLAMNTF_ZONE_I)
	...
	// LNTF_ZONE_II
	else if ( set_member == SRM_SRFSM_Lambert_NTF_Code.SRFSMLAMNTF_ZONE_II)
	    retSRF = new SRF_LambertConformalConic(orm,
						   rt,
						   0.0 * Const.RADIANS_PER_DEGREE, // origin_longitude
	...
	// LNTF_ZONE_III
	else if ( set_member == SRM_SRFSM_Lambert_NTF_Code.SRFSMLAMNTF_ZONE_III)
	    retSRF = new SRF_LambertConformalConic(orm,
						   rt,
						   0.0 * Const.RADIANS_PER_DEGREE, // origin_longitude
	...
	// LNTF_ZONE_IV
	else if ( set_member == SRM_SRFSM_Lambert_NTF_Code.SRFSMLAMNTF_ZONE_IV)
	    retSRF = new SRF_LambertConformalConic(orm,
						   rt,
						   0.0 * Const.RADIANS_PER_DEGREE, // origin_longitude
	...
	if ( orm != SRM_ORM_Code.ORM_JGD_2000 || rt != SRM_RT_Code.RT_JGD_2000_IDENTITY_BY_MEASUREMENT )
	    throw new SrmException( SrmException._INVALID_CODE, 
				    new String("createSRFSetMember: invalid Japan Rectangular Plane CS RT/ORM code") );

	if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_I)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_II)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing						
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_III)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing 
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_IV)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_V)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_VI)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_VII)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_VIII)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_IX)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_X)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_XI)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_XII)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_XIII)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_XIV)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_XV)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_XVI)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_XVII)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_XVIII)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
						(136.0)*Const.RADIANS_PER_DEGREE,
						...
						0.0, //false_easting
						0.0 );  //false_northing
	else if ( set_member == SRM_SRFSM_Japan_RPCS_Code.SRFSMJPRPCS_ZONE_XIX)
	    retSRF = new SRF_TransverseMercator(orm,
						rt,
	...
	// 
	if ( set_member == SRM_SRFSM_UPS_Code.SRFSMUPS_NORTHERN_POLE)
	...
	else if ( set_member == SRM_SRFSM_UPS_Code.SRFSMUPS_SOUTHERN_POLE)
	    retSRF = new SRF_PolarStereographic(orm,
						rt,
	...
	if ( set_member.toInt() >= SRM_SRFSM_UTM_Code._SRFSMUTM_ZONE_1_NORTHERN_HEMISPHERE && 
	     set_member.toInt() <= SRM_SRFSM_UTM_Code._SRFSMUTM_ZONE_60_NORTHERN_HEMISPHERE ) {
	    origin_longitude = ( (double)set_member.toInt() * 6.0 - 183.0) * Const.RADIANS_PER_DEGREE;
	    false_northing = 0.0;
	}
	// UTM zone between 61 and 120
	else if  ( set_member.toInt() >= SRM_SRFSM_UTM_Code._SRFSMUTM_ZONE_1_SOUTHERN_HEMISPHERE && 
	           set_member.toInt() <= SRM_SRFSM_UTM_Code._SRFSMUTM_ZONE_60_SOUTHERN_HEMISPHERE ) {
	...
	// WSPCS_SOUTH_ZONE
	if ( set_member == SRM_SRFSM_Wisconsin_SPCS_Code.SRFSMWNSPCS_SOUTH_ZONE )
	    retSRF = new SRF_LambertConformalConic(orm,
						   rt,
						   ...
						   0.0);  // false_northing
	// WSPCS_CENTRAL_ZONE
	else if ( set_member == SRM_SRFSM_Wisconsin_SPCS_Code.SRFSMWNSPCS_CENTRAL_ZONE )
	    retSRF = new SRF_LambertConformalConic(orm,
						   rt,
						   -90.0 * Const.RADIANS_PER_DEGREE, // origin_longitude
						   ...
						   0.0);  // false_northing
	// WSPCS_NORTH_ZONE
	else if ( set_member == SRM_SRFSM_Wisconsin_SPCS_Code.SRFSMWNSPCS_NORTH_ZONE )
	    retSRF = new SRF_LambertConformalConic(orm,
						   rt,
						   -90.0 * Const.RADIANS_PER_DEGREE, // origin_longitude
