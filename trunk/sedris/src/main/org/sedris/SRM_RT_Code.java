...
public class SRM_RT_Code extends Enum
{
    ...
    /// Undefined
    public static final int _RT_UNDEFINED = 0;
    /// Universal
    public static final int _RT_ABSTRACT_2D_IDENTITY = 1;
    /// Universal
    public static final int _RT_ABSTRACT_3D_IDENTITY = 2;
    /// Burkina Faso
    public static final int _RT_ADINDAN_1991_BURKINA_FASO = 3;
    /// Cameroon
    public static final int _RT_ADINDAN_1991_CAMEROON = 4;
    /// Ethiopia
    public static final int _RT_ADINDAN_1991_ETHIOPIA = 5;
    /// Mali
    public static final int _RT_ADINDAN_1991_MALI = 6;
    /// Mean Solution (Ethiopia and Sudan)
    public static final int _RT_ADINDAN_1991_MEAN_SOLUTION = 7;
    /// Senegal
    public static final int _RT_ADINDAN_1991_SENEGAL = 8;
    /// Sudan
    public static final int _RT_ADINDAN_1991_SUDAN = 9;
    /// Global (Adrastea)
    public static final int _RT_ADRASTEA_2000_IDENTITY = 10;
    /// Somalia
    public static final int _RT_AFGOOYE_1987_SOMALIA = 11;
    /// Bahrain Island
    public static final int _RT_AIN_EL_ABD_1970_BAHRAIN_ISLAND = 12;
    /// Saudi Arabia
    public static final int _RT_AIN_EL_ABD_1970_SAUDI_ARABIA = 13;
    /// Global (Amalthea)
    public static final int _RT_AMALTHEA_2000_IDENTITY = 14;
    /// American Samoa Islands
    public static final int _RT_AMERICAN_SAMOA_1962_AMERICAN_SAMOA_ISLANDS = 15;
    /// Cocos Islands
    public static final int _RT_ANNA_1_1965_COCOS_ISLANDS = 16;
    /// Antigua and Leeward Islands
    public static final int _RT_ANTIGUA_1943_ANTIGUA_LEEWARD_ISLANDS = 17;
    /// Zimbabwe
    public static final int _RT_ARC_1950_3_ZIMBABWE = 18;
    /// Botswana
    public static final int _RT_ARC_1950_BOTSWANA = 19;
    /// Burundi
    public static final int _RT_ARC_1950_BURUNDI = 20;
    /// Lesotho
    public static final int _RT_ARC_1950_LESOTHO = 21;
    /// Malawi
    public static final int _RT_ARC_1950_MALAWI = 22;
    /// Mean Solution (Botswana, Lesotho, Malawi, Swaziland, Zaire, Zambia and Zimbabwe)
    public static final int _RT_ARC_1950_MEAN_SOLUTION = 23;
    /// Swaziland
    public static final int _RT_ARC_1950_SWAZILAND = 24;
    /// Zaire
    public static final int _RT_ARC_1950_ZAIRE = 25;
    /// Zambia
    public static final int _RT_ARC_1950_ZAMBIA = 26;
    /// Kenya
    public static final int _RT_ARC_1960_3_KENYA = 27;
    /// Mean Solution (Kenya and Tanzania)
    public static final int _RT_ARC_1960_MEAN_SOLUTION = 28;
    /// Tanzania
    public static final int _RT_ARC_1960_TANZANIA = 29;
    /// Global (Ariel)
    public static final int _RT_ARIEL_1988_IDENTITY = 30;
    /// Ascension Island
    public static final int _RT_ASCENSION_1958_ASCENSION_ISLAND = 31;
    /// Global (Atlas)
    public static final int _RT_ATLAS_1988_IDENTITY = 32;
    /// Australia and Tasmania
    public static final int _RT_AUSTRALIAN_GEOD_1966_AUSTRALIA_TASMANIA = 33;
    /// Australia and Tasmania
    public static final int _RT_AUSTRALIAN_GEOD_1984_3_AUSTRALIA_TASMANIA = 34;
    /// Australia and Tasmania
    public static final int _RT_AUSTRALIAN_GEOD_1984_7_AUSTRALIA_TASMANIA = 35;
    /// Djibouti
    public static final int _RT_AYABELLE_LIGHTHOUSE_1991_DJIBOUTI = 36;
    /// Iwo Jima Island
    public static final int _RT_BEACON_E_1945_IWO_JIMA_ISLAND = 37;
    /// Global (Belinda)
    public static final int _RT_BELINDA_1988_IDENTITY = 38;
    /// Efate and Erromango Islands (Vanuatu)
    public static final int _RT_BELLEVUE_IGN_1987_EFATE_ERROMANGO_ISLANDS = 39;
    /// Bermuda
    public static final int _RT_BERMUDA_1957_BERMUDA = 40;
    /// Global (Bianca)
    public static final int _RT_BIANCA_1988_IDENTITY = 41;
    /// Guinea-Bissau
    public static final int _RT_BISSAU_1991_GUINEA_BISSAU = 42;
    /// Colombia
    public static final int _RT_BOGOTA_OBS_1987_COLOMBIA = 43;
    /// Colombia
    public static final int _RT_BOGOTA_OBS_1987_PM_BOGOTA_COLOMBIA = 44;
    /// Bangka and Belitung Islands (Indonesia)
    public static final int _RT_BUKIT_RIMPAH_1987_BANGKA_BELITUNG_ISLANDS = 45;
    /// Global (Callisto)
    public static final int _RT_CALLISTO_2000_IDENTITY = 46;
    /// Global (Calypso)
    public static final int _RT_CALYPSO_1988_IDENTITY = 47;
    /// McMurdo Camp Area (Antarctica)
    public static final int _RT_CAMP_AREA_1987_MCMURDO_CAMP = 48;
    /// Argentina
    public static final int _RT_CAMPO_INCHAUSPE_1969_ARGENTINA = 49;
    /// Phoenix Islands
    public static final int _RT_CANTON_1966_PHOENIX_ISLANDS = 50;
    /// South Africa
    public static final int _RT_CAPE_1987_SOUTH_AFRICA = 51;
    /// Mean Solution (Bahamas and Florida)
    public static final int _RT_CAPE_CANAVERAL_1991_MEAN_SOLUTION = 52;
    /// Tunisia
    public static final int _RT_CARTHAGE_1987_TUNISIA = 53;
    /// Global (Charon)
    public static final int _RT_CHARON_1991_IDENTITY = 54;
    /// Chatham Islands (New Zealand)
    public static final int _RT_CHATHAM_1971_CHATHAM_ISLANDS = 55;
   /// Paraguay
    public static final int _RT_CHUA_1987_PARAGUAY = 56;
    /// Global (Earth)
    public static final int _RT_COAMPS_1998_IDENTITY_BY_DEFAULT = 57;
    /// Global (Cordelia)
    public static final int _RT_CORDELIA_1988_IDENTITY = 58;
    /// Brazil
    public static final int _RT_CORREGO_ALEGRE_1987_BRAZIL = 59;
    /// Global (Cressida)
    public static final int _RT_CRESSIDA_1988_IDENTITY = 60;
    /// Guinea
    public static final int _RT_DABOLA_1991_GUINEA = 61;
    /// Deception Island (Antarctica)
    public static final int _RT_DECEPTION_1993_DECEPTION_ISLAND = 62;
    /// Global (Deimos)
    public static final int _RT_DEIMOS_1988_IDENTITY = 63;
    /// Global (Desdemona)
    public static final int _RT_DESDEMONA_1988_IDENTITY = 64;
    /// Global (Despina)
    public static final int _RT_DESPINA_1991_IDENTITY = 65;
    /// Global (Dione)
    public static final int _RT_DIONE_1982_IDENTITY = 66;
    /// Sumatra (Indonesia)
    public static final int _RT_DJAKARTA_1987_PM_DJAKARTA_SUMATRA = 67;
    /// Sumatra (Indonesia)
    public static final int _RT_DJAKARTA_1987_SUMATRA = 68;
    /// Gizo Island (New Georgia Islands)
    public static final int _RT_DOS_1968_GIZO_ISLAND = 69;
    /// St. Helena Island
    public static final int _RT_DOS_71_4_1987_ST_HELENA_ISLAND = 70;
    /// Easter Island
    public static final int _RT_EASTER_1967_EASTER_ISLAND = 71;
    /// Global (Enceladus)
    public static final int _RT_ENCELADUS_1994_IDENTITY = 72;
    /// Global (Epimetheus)
    public static final int _RT_EPIMETHEUS_1988_IDENTITY = 73;
    /// Global (Eros)
    public static final int _RT_EROS_2000_IDENTITY = 74;
    /// Estonia
    public static final int _RT_ESTONIA_1937_ESTONIA = 75;
    /// Europe
    public static final int _RT_ETRS_1989_IDENTITY_BY_MEASUREMENT = 76;
    /// Global (Europa)
    public static final int _RT_EUROPA_2000_IDENTITY = 77;
    /// Cyprus
    public static final int _RT_EUROPE_1950_3_CYPRUS = 78;
    /// Channel Islands
    public static final int _RT_EUROPE_1950_CHANNEL_ISLANDS = 79;
    /// Egypt
    public static final int _RT_EUROPE_1950_EGYPT = 80;
    /// England, Scotland, Channel Islands and Shetland Islands
    public static final int _RT_EUROPE_1950_ENGLAND_SCOTLAND = 81;
    /// Greece
    public static final int _RT_EUROPE_1950_GREECE = 82;
    /// Iran
    public static final int _RT_EUROPE_1950_IRAN = 83;
    /// Iraq
    public static final int _RT_EUROPE_1950_IRAQ = 84;
    /// Ireland, Northern Ireland, Wales, England, Scotland, Channel Islands, and Shetland Islands
    public static final int _RT_EUROPE_1950_IRELAND = 85;
    /// Malta
    public static final int _RT_EUROPE_1950_MALTA = 86;
    ...
    public static final int _RT_EUROPE_1950_MEAN_SOLUTION = 87;
    /// Finland and Norway
    public static final int _RT_EUROPE_1950_NORWAY = 88;
    /// Portugal and Spain
    public static final int _RT_EUROPE_1950_PORTUGAL_SPAIN = 89;
    /// Sardinia (Italy)
    public static final int _RT_EUROPE_1950_SARDINIA = 90;
    /// Sicily (Italy)
    public static final int _RT_EUROPE_1950_SICILY = 91;
    /// Tunisia
    public static final int _RT_EUROPE_1950_TUNISIA = 92;
    /// Western Europe Mean Solution (Austria, Denmark, France, FRG, Netherlands and Switzerland)
    public static final int _RT_EUROPE_1950_W_EUROPE_MEAN_SOLUTION = 93;
    /// Mean Solution (Austria, Finland, Netherlands, Norway, Spain, Sweden and Switzerland)
    public static final int _RT_EUROPE_1979_MEAN_SOLUTION = 94;
    /// Oman
    public static final int _RT_FAHUD_1987_3_OMAN = 95;
    /// Oman
    public static final int _RT_FAHUD_1987_7_OMAN = 96;
    /// St. Kitts, Nevis and Leeward Islands
    public static final int _RT_FORT_THOMAS_1955_ST_KITTS_NEVIS_LEEWARD_ISLANDS = 97;
    /// Global (Galatea)
    public static final int _RT_GALATEA_1991_IDENTITY = 98;
    /// Republic of Maldives
    public static final int _RT_GAN_1970_MALDIVES = 99;
    /// Global (Ganymede)
    public static final int _RT_GANYMEDE_2000_IDENTITY = 100;
    /// Global (Gaspra)
    public static final int _RT_GASPRA_1991_IDENTITY = 101;
    /// Australia
    public static final int _RT_GDA_1994_IDENTITY_BY_MEASUREMENT = 102;
    /// New Zealand
    public static final int _RT_GEODETIC_DATUM_1949_3_NEW_ZEALAND = 103;
    /// New Zealand
    public static final int _RT_GEODETIC_DATUM_1949_7_NEW_ZEALAND = 104;
    /// Global (Earth)
    public static final int _RT_GEOMAGNETIC_1945_DGRF = 105;
    /// Global (Earth)
    public static final int _RT_GEOMAGNETIC_1950_DGRF = 106;
    /// Global (Earth)
    public static final int _RT_GEOMAGNETIC_1955_DGRF = 107;
    /// Global (Earth)
    public static final int _RT_GEOMAGNETIC_1960_DGRF = 108;
    /// Global (Earth)
    public static final int _RT_GEOMAGNETIC_1965_DGRF = 109;
    /// Global (Earth)
    public static final int _RT_GEOMAGNETIC_1970_DGRF = 110;
    /// Global (Earth)
    public static final int _RT_GEOMAGNETIC_1975_DGRF = 111;
    /// Global (Earth)
    public static final int _RT_GEOMAGNETIC_1980_DGRF = 112;
    /// Global (Earth)
    public static final int _RT_GEOMAGNETIC_1985_DGRF = 113;
    /// Global (Earth)
    public static final int _RT_GEOMAGNETIC_1990_DGRF = 114;
    /// Global (Earth)
    public static final int _RT_GEOMAGNETIC_1995_IGRF = 115;
    /// Global (Earth)
    public static final int _RT_GEOMAGNETIC_2000_IGRF = 116;
    /// Central Azores (Faial, Graciosa, Pico, Sao Jorge and Terceira Islands)
    public static final int _RT_GRACIOSA_BASE_SW_1948_CENTRAL_AZORES = 117;
    /// Guam
    public static final int _RT_GUAM_1963_GUAM = 118;
    /// Kalimantan Island (Indonesia)
    public static final int _RT_GUNONG_SEGARA_1987_KALIMANTAN_ISLAND = 119;
    /// Guadalcanal Island
    public static final int _RT_GUX_1_1987_GUADALCANAL_ISLAND = 120;
    /// Global (Helene)
    public static final int _RT_HELENE_1992_IDENTITY = 121;
    /// Afghanistan
    public static final int _RT_HERAT_NORTH_1987_AFGHANISTAN = 122;
    /// Yugoslavia (prior to 1990), Slovenia, Croatia, Bosnia and Herzegovina, and Serbia
    public static final int _RT_HERMANNSKOGEL_1871_3_YUGOSLAVIA = 123;
    /// Iceland
    public static final int _RT_HJORSEY_1955_ICELAND = 124;
    /// Hong Kong
    public static final int _RT_HONG_KONG_1963_HONG_KONG = 125;
    /// Taiwan
    public static final int _RT_HU_TZU_SHAN_1991_TAIWAN = 126;
    /// Global (Iapetus)
    public static final int _RT_IAPETUS_1988_IDENTITY = 127;
    /// Global (Ida)
    public static final int _RT_IDA_1991_IDENTITY = 128;
    /// Bangladesh
    public static final int _RT_INDIAN_1916_3_BANGLADESH = 129;
    /// Bangladesh
    public static final int _RT_INDIAN_1916_7_BANGLADESH = 130;
    /// Thailand
    public static final int _RT_INDIAN_1954_THAILAND = 131;
    /// India and Nepal
    public static final int _RT_INDIAN_1956_INDIA_NEPAL = 132;
    /// Con Son Island (Vietnam)
    public static final int _RT_INDIAN_1960_CON_SON_ISLAND = 133;
    /// Vietnam (near 16 deg. N)
    public static final int _RT_INDIAN_1960_VIETNAM_16_N = 134;
    /// Pakistan
    public static final int _RT_INDIAN_1962_PAKISTAN = 135;
    /// Thailand
    public static final int _RT_INDIAN_1975_1991_THAILAND = 136;
    /// Thailand
    public static final int _RT_INDIAN_1975_1997_THAILAND = 137;
    /// Indonesia
    public static final int _RT_INDONESIAN_1974_INDONESIA = 138;
    /// Global (Io)
    public static final int _RT_IO_2000_IDENTITY = 139;
    /// Ireland
    public static final int _RT_IRELAND_1965_3_IRELAND = 140;
    /// Ireland
    public static final int _RT_IRELAND_1965_7_IRELAND = 141;
    /// South Georgia Island
    public static final int _RT_ISTS_061_1968_SOUTH_GEORGIA_ISLAND = 142;
    /// Diego Garcia
    public static final int _RT_ISTS_073_1969_DIEGO_GARCIA = 143;
    /// Global (Janus)
    public static final int _RT_JANUS_1988_IDENTITY = 144;
    /// Japan
    public static final int _RT_JGD_2000_IDENTITY_BY_MEASUREMENT = 145;
    /// Johnston Island
    public static final int _RT_JOHNSTON_1961_JOHNSTON_ISLAND = 146;
    /// Global (Juliet)
    public static final int _RT_JULIET_1988_IDENTITY = 147;
    /// Global (Jupiter)
    public static final int _RT_JUPITER_1988_IDENTITY = 148;
    /// Global (Jupiter)
    public static final int _RT_JUPITER_MAGNETIC_1993_VOYAGER = 149;
    /// Sri Lanka
    public static final int _RT_KANDAWALA_1987_3_SRI_LANKA = 150;
    /// Kerguelen Island
    public static final int _RT_KERGUELEN_1949_KERGUELEN_ISLAND = 151;
    /// West Malaysia and Singapore
    public static final int _RT_KERTAU_1948_3_W_MALAYSIA_SINGAPORE = 152;
    /// South Korea
    public static final int _RT_KOREAN_GEODETIC_1995_SOUTH_KOREA = 153;
    /// Caroline Islands (Federated States of Micronesia)
    public static final int _RT_KUSAIE_1951_CAROLINE_ISLANDS = 154;
    /// Global (Larissa)
    public static final int _RT_LARISSA_1991_IDENTITY = 155;
    /// Cayman Brac Island
    public static final int _RT_LC5_1961_CAYMAN_BRAC_ISLAND = 156;
    /// Ghana
    public static final int _RT_LEIGON_1991_3_GHANA = 157;
    /// Ghana
    public static final int _RT_LEIGON_1991_7_GHANA = 158;
    /// Liberia
    public static final int _RT_LIBERIA_1964_LIBERIA = 159;
    /// Mindanao Island (Philippines)
    public static final int _RT_LUZON_1987_MINDANAO_ISLAND = 160;
    /// Philippines (excluding Mindanao Island)
    public static final int _RT_LUZON_1987_PHILIPPINES_EXCLUDING_MINDANAO_ISLAND = 161;
    /// Gabon
    public static final int _RT_M_PORALOKO_1991_GABON = 162;
    /// Mahe Island (Seychelles)
    public static final int _RT_MAHE_1971_MAHE_ISLAND = 163;
    /// Marcus Islands
    public static final int _RT_MARCUS_STATION_1952_MARCUS_ISLANDS = 164;
    /// Global (Mars)
    public static final int _RT_MARS_2000_IDENTITY = 165;
    /// Global (Mars)
    public static final int _RT_MARS_SPHERE_2000_GLOBAL = 166;
    /// Global (Earth)
    public static final int _RT_MASS_1999_IDENTITY_BY_DEFAULT = 167;
    /// Eritrea and Ethiopia
    public static final int _RT_MASSAWA_1987_ERITREA_ETHIOPIA = 168;
    /// Morocco
    public static final int _RT_MERCHICH_1987_MOROCCO = 169;
    /// Global (Mercury)
    public static final int _RT_MERCURY_1988_IDENTITY = 170;
    /// Global (Metis)
    public static final int _RT_METIS_2000_IDENTITY = 171;
    /// Midway Islands
    public static final int _RT_MIDWAY_1961_MIDWAY_ISLANDS = 172;
    /// Global (Mimas)
    public static final int _RT_MIMAS_1994_IDENTITY = 173;
    /// Cameroon
    public static final int _RT_MINNA_1991_CAMEROON = 174;
    /// Nigeria
    public static final int _RT_MINNA_1991_NIGERIA = 175;
    /// Global (Miranda)
    public static final int _RT_MIRANDA_1988_IDENTITY = 176;
    /// Global (Earth)
    public static final int _RT_MM5_1997_IDENTITY_BY_DEFAULT = 177;
    /// Northern midlatitude regions (Earth)
    public static final int _RT_MODTRAN_MIDLATITUDE_N_1989_IDENTITY_BY_DEFAULT = 178;
    /// Southern midlatitude regions (Earth)
    public static final int _RT_MODTRAN_MIDLATITUDE_S_1989_IDENTITY_BY_DEFAULT = 179;
    /// Northern subarctic regions (Earth)
    public static final int _RT_MODTRAN_SUBARCTIC_N_1989_IDENTITY_BY_DEFAULT = 180;
    /// Southern subarctic regions (Earth)
    public static final int _RT_MODTRAN_SUBARCTIC_S_1989_IDENTITY_BY_DEFAULT = 181;
    /// Tropical regions (Earth)
    public static final int _RT_MODTRAN_TROPICAL_1989_IDENTITY_BY_DEFAULT = 182;
    /// Montserrat and Leeward Islands
    public static final int _RT_MONTSERRAT_1958_MONTSERRAT_LEEWARD_ISLANDS = 183;
    /// Global (Moon)
    public static final int _RT_MOON_1991_IDENTITY = 184;
    /// Global (Earth)
    public static final int _RT_MULTIGEN_FLAT_EARTH_1989_IDENTITY_BY_DEFAULT = 185;
    /// Alaska (excluding Aleutian Islands)
    public static final int _RT_N_AM_1927_ALASKA_EXCLUDING_ALEUTIAN_ISLANDS = 186;
    /// Canada (Alberta and British Columbia)
    public static final int _RT_N_AM_1927_ALBERTA_BRITISH_COLUMBIA = 187;
    /// Bahamas (excluding San Salvador Island)
    public static final int _RT_N_AM_1927_BAHAMAS_EXCLUDING_SAN_SALVADOR_ISLAND = 188;
    /// Canada
    public static final int _RT_N_AM_1927_CANADA = 189;
    /// Canal Zone
    public static final int _RT_N_AM_1927_CANAL_ZONE = 190;
    /// Caribbean (Antigua Island, Barbados, Barbuda, Caicos Islands, Cuba, Dominican Republic, Grand Cayman, Jamaica and Turks Islands)
    public static final int _RT_N_AM_1927_CARIBBEAN = 191;
    /// Central America (Belize, Costa Rica, El Salvador, Guatemala, Honduras and Nicaragua)
    public static final int _RT_N_AM_1927_CENTRAL_AMERICA = 192;
    /// Continental United States Mean Solution
    public static final int _RT_N_AM_1927_CONTINENTAL_US = 193;
    /// Cuba
    public static final int _RT_N_AM_1927_CUBA = 194;
    /// Aleutian Islands (east of 180 deg. W)
    public static final int _RT_N_AM_1927_EAST_ALEUTIAN_ISLANDS = 195;
    /// Eastern Canada (New Brunswick, Newfoundland, Nova Scotia and Quebec)
    public static final int _RT_N_AM_1927_EASTERN_CANADA = 196;
    ...
    public static final int _RT_N_AM_1927_EASTERN_US = 197;
    /// Hayes Peninsula (Greenland)
    public static final int _RT_N_AM_1927_HAYES_PENINSULA = 198;
    /// Canada (Manitoba and Ontario)
    public static final int _RT_N_AM_1927_MANITOBA_ONTARIO = 199;
    /// Mexico
    public static final int _RT_N_AM_1927_MEXICO = 200;
    /// Canada (Northwest Territories and Saskatchewan)
    public static final int _RT_N_AM_1927_NORTHWEST_TERRITORIES_SASKATCHEWAN = 201;
    /// San Salvador Island
    public static final int _RT_N_AM_1927_SAN_SALVADOR_ISLAND = 202;
    /// Aleutian Islands (west of 180 deg. W)
    public static final int _RT_N_AM_1927_WEST_ALEUTIAN_ISLANDS = 203;
    ...
    public static final int _RT_N_AM_1927_WESTERN_US = 204;
    /// Canada (Yukon)
    public static final int _RT_N_AM_1927_YUKON = 205;
    /// Alaska (excluding Aleutian Islands)
    public static final int _RT_N_AM_1983_ALASKA_EXCLUDING_ALEUTIAN_ISLANDS = 206;
    /// Aleutian Islands
    public static final int _RT_N_AM_1983_ALEUTIAN_ISLANDS = 207;
    /// Canada
    public static final int _RT_N_AM_1983_CANADA = 208;
    /// Continental United States
    public static final int _RT_N_AM_1983_CONTINENTAL_US = 209;
    /// Hawaii
    public static final int _RT_N_AM_1983_HAWAII = 210;
    /// Mexico and Central America
    public static final int _RT_N_AM_1983_MEXICO_CENTRAL_AMERICA = 211;
    /// Algeria
    public static final int _RT_N_SAHARA_1959_ALGERIA = 212;
    /// Masirah Island (Oman)
    public static final int _RT_NAHRWAN_1987_MASIRAH_ISLAND = 213;
    /// Saudi Arabia
    public static final int _RT_NAHRWAN_1987_SAUDI_ARABIA = 214;
    /// United Arab Emirates
    public static final int _RT_NAHRWAN_1987_UNITED_ARAB_EMIRATES = 215;
    /// Global (Naiad)
    public static final int _RT_NAIAD_1991_IDENTITY = 216;
    /// Trinidad and Tobago (British West Indies)
    public static final int _RT_NAPARIMA_1991_TRINIDAD_TOBAGO = 217;
    /// Global (Neptune)
    public static final int _RT_NEPTUNE_1991_IDENTITY = 218;
    /// Global (Neptune)
    public static final int _RT_NEPTUNE_MAGNETIC_1993_VOYAGER = 219;
    /// Global (Earth)
    public static final int _RT_NOGAPS_1988_IDENTITY_BY_DEFAULT = 220;
    /// France
    public static final int _RT_NTF_1896_FRANCE = 221;
    /// France
    public static final int _RT_NTF_1896_PM_PARIS_FRANCE = 222;
    /// Global (Oberon)
    public static final int _RT_OBERON_1988_IDENTITY = 223;
    /// Corvo Flores Islands (Azores)
    public static final int _RT_OBSERV_METEORO_1939_CORVO_FLORES_ISLANDS = 224;
    /// Egypt
    public static final int _RT_OLD_EGYPTIAN_1907_EGYPT = 225;
    /// Hawaii (US)
    public static final int _RT_OLD_HAWAIIAN_CLARKE_1987_HAWAII = 226;
    /// Kauai (US)
    public static final int _RT_OLD_HAWAIIAN_CLARKE_1987_KAUAI = 227;
    /// Maui (US)
    public static final int _RT_OLD_HAWAIIAN_CLARKE_1987_MAUI = 228;
    /// Mean Solution (Hawaii (US))
    public static final int _RT_OLD_HAWAIIAN_CLARKE_1987_MEAN_SOLUTION = 229;
    /// Oahu (US)
    public static final int _RT_OLD_HAWAIIAN_CLARKE_1987_OAHU = 230;
    /// Hawaii (US)
    public static final int _RT_OLD_HAWAIIAN_INT_1987_HAWAII = 231;
    /// Kauai (US)
    public static final int _RT_OLD_HAWAIIAN_INT_1987_KAUAI = 232;
    /// Maui (US)
    public static final int _RT_OLD_HAWAIIAN_INT_1987_MAUI = 233;
    /// Mean Solution (Hawaii (US))
    public static final int _RT_OLD_HAWAIIAN_INT_1987_MEAN_SOLUTION = 234;
    /// Oahu (US)
    public static final int _RT_OLD_HAWAIIAN_INT_1987_OAHU = 235;
    /// Global (Ophelia)
    public static final int _RT_OPHELIA_1988_IDENTITY = 236;
    /// Mean Solution (England, Isle of Man, Scotland, Shetland, and Wales)
    public static final int _RT_OSGB_1936_3_MEAN_SOLUTION = 237;
    /// Great Britain
    public static final int _RT_OSGB_1936_7_GREAT_BRITAIN = 238;
    /// England
    public static final int _RT_OSGB_1936_ENGLAND = 239;
    /// England, Isle of Man, and Wales
    public static final int _RT_OSGB_1936_ENGLAND_ISLE_OF_MAN_WALES = 240;
    /// Scotland and Shetland Islands
    public static final int _RT_OSGB_1936_SCOTLAND_SHETLAND_ISLANDS = 241;
    /// Wales
    public static final int _RT_OSGB_1936_WALES = 242;
    /// Global (Pan)
    public static final int _RT_PAN_1991_IDENTITY = 243;
    /// Global (Pandora)
    public static final int _RT_PANDORA_1988_IDENTITY = 244;
    /// Global (Phobos)
    public static final int _RT_PHOBOS_1988_IDENTITY = 245;
    /// Global (Phoebe)
    public static final int _RT_PHOEBE_1988_IDENTITY = 246;
    /// Canary Islands (Spain)
    public static final int _RT_PICO_DE_LAS_NIEVES_1987_CANARY_ISLANDS = 247;
    /// Pitcairn Island
    public static final int _RT_PITCAIRN_1967_PITCAIRN_ISLAND = 248;
    /// Global (Pluto)
    public static final int _RT_PLUTO_1994_IDENTITY = 249;
    /// Mean Solution (Burkina Faso and Niger)
    public static final int _RT_POINT_58_1991_MEAN_SOLUTION = 250;
    /// Congo
    public static final int _RT_POINTE_NOIRE_1948_CONGO = 251;
    /// Global (Portia)
    public static final int _RT_PORTIA_1988_IDENTITY = 252;
    /// Porto Santo and Madeira Islands
    public static final int _RT_PORTO_SANTO_1936_PORTO_SANTO_MADEIRA_ISLANDS = 253;
    /// Global (Prometheus)
    public static final int _RT_PROMETHEUS_1988_IDENTITY = 254;
    /// Global (Proteus)
    public static final int _RT_PROTEUS_1991_IDENTITY = 255;
    /// Venezuela
    public static final int _RT_PROV_S_AM_1956_3_VENEZUELA = 256;
    /// Venezuela
    public static final int _RT_PROV_S_AM_1956_7_VENEZUELA = 257;
    /// Bolivia
    public static final int _RT_PROV_S_AM_1956_BOLIVIA = 258;
    /// Colombia
    public static final int _RT_PROV_S_AM_1956_COLOMBIA = 259;
    /// Ecuador
    public static final int _RT_PROV_S_AM_1956_ECUADOR = 260;
    /// Guyana
    public static final int _RT_PROV_S_AM_1956_GUYANA = 261;
    /// Mean Solution (Bolivia, Chile, Colombia, Ecuador, Guyana, Peru and Venezuela)
    public static final int _RT_PROV_S_AM_1956_MEAN_SOLUTION = 262;
    /// Northern Chile (near 19 deg. S)
    public static final int _RT_PROV_S_AM_1956_N_CHILE_19_S = 263;
    /// Peru
    public static final int _RT_PROV_S_AM_1956_PERU = 264;
    /// Southern Chile (near 43 deg. S)
    public static final int _RT_PROV_S_AM_1956_S_CHILE_43_S = 265;
    /// South Chile (near 53 deg. S)
    public static final int _RT_PROV_S_CHILEAN_1963_SOUTH_CHILE = 266;
    /// Global (Puck)
    public static final int _RT_PUCK_1988_IDENTITY = 267;
    /// Puerto Rico and Virgin Islands
    public static final int _RT_PUERTO_RICO_1987_PUERTO_RICO_VIRGIN_ISLANDS = 268;
    /// Russia
    public static final int _RT_PULKOVO_1942_RUSSIA = 269;
    /// Qatar
    public static final int _RT_QATAR_NATIONAL_1974_3_QATAR = 270;
    /// South Greenland
    public static final int _RT_QORNOQ_1987_SOUTH_GREENLAND = 271;
    /// Mascarene Islands
    public static final int _RT_REUNION_1947_MASCARENE_ISLANDS = 272;
    /// France
    public static final int _RT_RGF_1993_IDENTITY_BY_MEASUREMENT = 273;
    /// Global (Rhea)
    public static final int _RT_RHEA_1988_IDENTITY = 274;
    /// Sardinia (Italy)
    public static final int _RT_ROME_1940_PM_ROME_SARDINIA = 275;
    /// Sardinia (Italy)
    public static final int _RT_ROME_1940_SARDINIA = 276;
    /// Global (Rosalind)
    public static final int _RT_ROSALIND_1988_IDENTITY = 277;
    /// Argentina
    public static final int _RT_S_AM_1969_ARGENTINA = 278;
    /// Baltra and Galapagos Islands (Ecuador)
    public static final int _RT_S_AM_1969_BALTRA_GALAPAGOS_ISLANDS = 279;
    /// Bolivia
    public static final int _RT_S_AM_1969_BOLIVIA = 280;
    /// Brazil
    public static final int _RT_S_AM_1969_BRAZIL = 281;
    /// Chile
    public static final int _RT_S_AM_1969_CHILE = 282;
    /// Colombia
    public static final int _RT_S_AM_1969_COLOMBIA = 283;
    /// Ecuador (excluding Galapagos Islands)
    public static final int _RT_S_AM_1969_ECUADOR_EXCLUDING_GALAPAGOS_ISLANDS = 284;
    /// Guyana
    public static final int _RT_S_AM_1969_GUYANA = 285;
    /// Mean Solution (Argentina, Bolivia, Brazil, Chile, Colombia, Ecuador, Guyana, Paraguay, Peru, Trinidad and Tobago, and Venezuela)
    public static final int _RT_S_AM_1969_MEAN_SOLUTION = 286;
    /// Paraguay
    public static final int _RT_S_AM_1969_PARAGUAY = 287;
    /// Peru
    public static final int _RT_S_AM_1969_PERU = 288;
    /// Trinidad and Tobago (British West Indies)
    public static final int _RT_S_AM_1969_TRINIDAD_TOBAGO = 289;
    /// Venezuela
    public static final int _RT_S_AM_1969_VENEZUELA = 290;
    /// Singapore
    public static final int _RT_S_ASIA_1987_SINGAPORE = 291;
    /// Czech Republic
    public static final int _RT_S_JTSK_1993_CZECH_REP = 292;
    /// Czech Republic and Slovakia
    public static final int _RT_S_JTSK_1993_CZECH_REP_SLOVAKIA = 293;
    /// Poland
    public static final int _RT_S42_PULKOVO_3_POLAND = 294;
    /// Albania
    public static final int _RT_S42_PULKOVO_ALBANIA = 295;
    /// Czech Republic and Slovakia
    public static final int _RT_S42_PULKOVO_CZECH_REPUBLIC_SLOVAKIA = 296;
    /// Romania
    public static final int _RT_S42_PULKOVO_G_ROMANIA = 297;
    /// Hungary
    public static final int _RT_S42_PULKOVO_HUNGARY = 298;
    /// Kazakhstan
    public static final int _RT_S42_PULKOVO_KAZAKHSTAN = 299;
    /// Latvia
    public static final int _RT_S42_PULKOVO_LATVIA = 300;
    /// Espirito Santo Island (Vanuatu)
    public static final int _RT_SANTO_DOS_1965_ESPIRITO_SANTO_ISLAND = 301;
    /// Sao Miguel and Santa Maria Islands (Azores)
    public static final int _RT_SAO_BRAZ_1987_SAO_MIGUEL_SANTA_MARIA_ISLANDS = 302;
    /// East Falkland Islands
    public static final int _RT_SAPPER_HILL_1943_3_E_FALKLAND_ISLANDS = 303;
    /// Global (Saturn)
    public static final int _RT_SATURN_1988_IDENTITY = 304;
    /// Global (Saturn)
    public static final int _RT_SATURN_MAGNETIC_1993_VOYAGER = 305;
    /// Namibia
    public static final int _RT_SCHWARZECK_1991_NAMIBIA = 306;
    /// Salvage Islands (Ilhas Selvagens; Savage Islands)
    public static final int _RT_SELVAGEM_GRANDE_1938_SALVAGE_ISLANDS = 307;
    /// Sierra Leone
    public static final int _RT_SIERRA_LEONE_1960_SIERRA_LEONE = 308;
    /// South America
    public static final int _RT_SIRGAS_2000_IDENTITY_BY_MEASUREMENT = 309;
    /// Global (Sun)
    public static final int _RT_SUN_1992_IDENTITY = 310;
    /// Madagascar
    public static final int _RT_TANANARIVE_OBS_1925_3_MADAGASCAR = 311;
    /// Madagascar
    public static final int _RT_TANANARIVE_OBS_1925_PM_PARIS_3_MADAGASCAR = 312;
    /// Global (Telesto)
    public static final int _RT_TELESTO_1988_IDENTITY = 313;
    /// Tern Island (French Frigate Shoals, Hawaiian Islands)
    public static final int _RT_TERN_1961_TERN_ISLAND = 314;
    /// Global (Tethys)
    public static final int _RT_TETHYS_1991_IDENTITY = 315;
    /// Global (Thalassa)
    public static final int _RT_THALASSA_1991_IDENTITY = 316;
    /// Global (Thebe)
    public static final int _RT_THEBE_2000_IDENTITY = 317;
    /// Brunei and East Malaysia (Sabah and Sarawak)
    public static final int _RT_TIMBALAI_EVEREST_1948_3_BRUNEI_E_MALAYSIA = 318;
    /// Brunei and East Malaysia (Sabah and Sarawak)
    public static final int _RT_TIMBALAI_EVEREST_1948_7_BRUNEI_E_MALAYSIA = 319;
    /// Global (Titan)
    public static final int _RT_TITAN_1982_IDENTITY = 320;
    /// Global (Titania)
    public static final int _RT_TITANIA_1988_IDENTITY = 321;
    /// Japan
    public static final int _RT_TOKYO_1991_JAPAN = 322;
    /// Mean Solution (Japan, Korea, and Okinawa)
    public static final int _RT_TOKYO_1991_MEAN_SOLUTION = 323;
    /// Okinawa (Japan)
    public static final int _RT_TOKYO_1991_OKINAWA = 324;
    /// South Korea
    public static final int _RT_TOKYO_1991_1991_SOUTH_KOREA = 325;
    /// South Korea
    public static final int _RT_TOKYO_1991_1997_SOUTH_KOREA = 326;
    /// Tristan da Cunha
    public static final int _RT_TRISTAN_1968_TRISTAN_DA_CUNHA = 327;
    /// Global (Triton)
    public static final int _RT_TRITON_1991_IDENTITY = 328;
    /// Global (Umbriel)
    public static final int _RT_UMBRIEL_1988_IDENTITY = 329;
    /// Global (Uranus)
    public static final int _RT_URANUS_1988_IDENTITY = 330;
    /// Global (Uranus)
    public static final int _RT_URANUS_MAGNETIC_1993_VOYAGER = 331;
    /// Global (Venus)
    public static final int _RT_VENUS_1991_IDENTITY = 332;
    /// Viti Levu Island (Fiji Islands)
    public static final int _RT_VITI_LEVU_1916_VITI_LEVU_ISLANDS = 333;
    /// Algeria
    public static final int _RT_VOIROL_1874_ALGERIA = 334;
    /// Algeria
    public static final int _RT_VOIROL_1874_PM_PARIS_ALGERIA = 335;
    /// Algeria
    public static final int _RT_VOIROL_1960_ALGERIA = 336;
    /// Algeria
    public static final int _RT_VOIROL_1960_PM_PARIS_ALGERIA = 337;
   /// Wake Atoll
    public static final int _RT_WAKE_1952_WAKE_ATOLL = 338;
    /// Marshall Islands
    public static final int _RT_WAKE_ENIWETOK_1960_MARSHALL_ISLANDS = 339;
    /// Global (Earth)
    public static final int _RT_WGS_1972_GLOBAL = 340;
    /// Global (Earth)
    public static final int _RT_WGS_1984_IDENTITY = 341;
    /// Uruguay
    public static final int _RT_YACARE_1987_URUGUAY = 342;
    /// Suriname
    public static final int _RT_ZANDERIJ_1987_SURINAME = 343;

    // Added for the NGA Golden Data testing
    public static final int _RT_EXPERIMENTAL_NGA_SPHERE_IDENTITY_BY_DEFAULT = -1001;
    // Added for the NGA Golden Data testing
    public static final int _RT_EXPERIMENTAL_NGA_MAX_IDENTITY_BY_DEFAULT = -1000;
    ...
    public static final SRM_RT_Code RT_EXPERIMENTAL_NGA_MAX_IDENTITY_BY_DEFAULT
        = new SRM_RT_Code( _RT_EXPERIMENTAL_NGA_MAX_IDENTITY_BY_DEFAULT, "RT_EXPERIMENTAL_NGA_MAX_IDENTITY_BY_DEFAULT" );
    public static final SRM_RT_Code RT_EXPERIMENTAL_NGA_SPHERE_IDENTITY_BY_DEFAULT
        = new SRM_RT_Code( _RT_EXPERIMENTAL_NGA_SPHERE_IDENTITY_BY_DEFAULT, "RT_EXPERIMENTAL_NGA_SPHERE_IDENTITY_BY_DEFAULT" );
    ...
    private SRM_RT_Code(int code, String name)
    {
        ...
        else if (code == _RT_EXPERIMENTAL_NGA_MAX_IDENTITY_BY_DEFAULT)
        {
            _enumVec.add( _totalEnum, this );
        }
        else if (code == _RT_EXPERIMENTAL_NGA_SPHERE_IDENTITY_BY_DEFAULT)
        {
    ...
    public static SRM_RT_Code getEnum(int enum_value) throws SrmException
    {
        ...
        else if (enum_value == _RT_EXPERIMENTAL_NGA_MAX_IDENTITY_BY_DEFAULT)
            return (SRM_RT_Code)(_enumVec.elementAt( _totalEnum ));
        else if (enum_value == _RT_EXPERIMENTAL_NGA_SPHERE_IDENTITY_BY_DEFAULT)
