...
public class SRM_ORM_Code extends Enum
{
    ...
    public static final int _ORM_ANNA_1_1965 = 9; /// Anna 1 (astronomic)
    public static final int _ORM_ANTIGUA_1943 = 10; /// Antigua (astronomic)
    public static final int _ORM_ARC_1950 = 11; /// Arc
    public static final int _ORM_ARC_1960 = 12; /// Arc
    public static final int _ORM_ARIEL_1988 = 13; /// Ariel
    public static final int _ORM_ASCENSION_1958 = 14; /// Ascension
    public static final int _ORM_ATLAS_1988 = 15; /// Atlas
    public static final int _ORM_AUSTRALIAN_GEOD_1966 = 16; /// Australian Geodetic
    public static final int _ORM_AUSTRALIAN_GEOD_1984 = 17; /// Australian Geodetic
    public static final int _ORM_AYABELLE_LIGHTHOUSE_1991 = 18; /// Ayabelle Lighthouse (Djibouti)
    public static final int _ORM_BEACON_E_1945 = 19; /// Beacon E (Iwo-jima; astronomic)
    public static final int _ORM_BELINDA_1988 = 20; /// Belinda
    public static final int _ORM_BELLEVUE_IGN_1987 = 21; /// Bellevue (IGN)
    public static final int _ORM_BERMUDA_1957 = 22; /// Bermuda
    public static final int _ORM_BIANCA_1988 = 23; /// Bianca
    public static final int _ORM_BISSAU_1991 = 24; /// Bissau
    public static final int _ORM_BOGOTA_OBS_1987 = 25; /// Bogota Observatory
    public static final int _ORM_BOGOTA_OBS_1987_PM_BOGOTA = 26; /// Bogota Observatory (with the Prime Meridian at Bogota)
    public static final int _ORM_BUKIT_RIMPAH_1987 = 27; /// Bukit Rimpah
    public static final int _ORM_CALLISTO_2000 = 28; /// Callisto
    public static final int _ORM_CALYPSO_1988 = 29; /// Calypso
    public static final int _ORM_CAMP_AREA_1987 = 30; /// Camp Area (astronomic)
    public static final int _ORM_CAMPO_INCHAUSPE_1969 = 31; /// Campo Inchauspe
    public static final int _ORM_CANTON_1966 = 32; /// Canton (astronomic)
    public static final int _ORM_CAPE_1987 = 33; /// Cape
    public static final int _ORM_CAPE_CANAVERAL_1991 = 34; /// Cape Canaveral
    public static final int _ORM_CARTHAGE_1987 = 35; /// Carthage
    public static final int _ORM_CHARON_1991 = 36; /// Charon
    public static final int _ORM_CHATHAM_1971 = 37; /// Chatam (astronomic)
    public static final int _ORM_CHUA_1987 = 38; /// Chua (astronomic)
    public static final int _ORM_COAMPS_1998 = 39; /// COAMPS^(TM)
    public static final int _ORM_CORDELIA_1988 = 40; /// Cordelia
    public static final int _ORM_CORREGO_ALEGRE_1987 = 41; /// Corrego Alegre
    public static final int _ORM_CRESSIDA_1988 = 42; /// Cressida
    public static final int _ORM_DABOLA_1991 = 43; /// Dabola
    public static final int _ORM_DECEPTION_1993 = 44; /// Deception
    public static final int _ORM_DEIMOS_1988 = 45; /// Deimos
    public static final int _ORM_DESDEMONA_1988 = 46; /// Desdemona
    public static final int _ORM_DESPINA_1991 = 47; /// Despina
    public static final int _ORM_DIONE_1982 = 48; /// Dione
    public static final int _ORM_DJAKARTA_1987 = 49; /// Djakarta (also known as Batavia)
    public static final int _ORM_DJAKARTA_1987_PM_DJAKARTA = 50; /// Djakarta (also known as Batavia; with the Prime Meridian at Djakarta)
    public static final int _ORM_DOS_1968 = 51; /// DOS
    public static final int _ORM_DOS_71_4_1987 = 52; /// DOS 71/4 (St. Helena Island; astronomic)
    public static final int _ORM_EARTH_INERTIAL_ARIES_1950 = 53; /// Earth equatorial inertial, Aries mean of 1950
    public static final int _ORM_EARTH_INERTIAL_ARIES_TRUE_OF_DATE = 54; /// Earth equatorial inertial, Aries true of date
    public static final int _ORM_EARTH_INERTIAL_J2000r0 = 55; /// Earth equatorial inertial, J2000.0
    public static final int _ORM_EARTH_SOLAR_ECLIPTIC = 56; /// Solar ecliptic
    public static final int _ORM_EARTH_SOLAR_EQUATORIAL = 57; /// Solar equatorial
    public static final int _ORM_EARTH_SOLAR_MAG_DIPOLE = 58; /// Solar magnetic dipole
    public static final int _ORM_EARTH_SOLAR_MAGNETOSPHERIC = 59; /// Solar magnetospheric
    public static final int _ORM_EASTER_1967 = 60; /// Easter
    public static final int _ORM_ENCELADUS_1994 = 61; /// Enceladus
    public static final int _ORM_EPIMETHEUS_1988 = 62; /// Epimetheus
    public static final int _ORM_EROS_2000 = 63; /// Eros (asteroid 433)
    public static final int _ORM_ESTONIA_1937 = 64; /// Estonia
    public static final int _ORM_ETRS_1989 = 65; /// ETRS
    public static final int _ORM_EUROPA_2000 = 66; /// Europa
    public static final int _ORM_EUROPE_1950 = 67; /// European
    public static final int _ORM_EUROPE_1979 = 68; /// European
    public static final int _ORM_FAHUD_1987 = 69; /// Fahud
    public static final int _ORM_FORT_THOMAS_1955 = 70; /// Fort Thomas
    public static final int _ORM_GALATEA_1991 = 71; /// Galatea
    public static final int _ORM_GAN_1970 = 72; /// Gan
    public static final int _ORM_GANYMEDE_2000 = 73; /// Ganymede
    public static final int _ORM_GASPRA_1991 = 74; /// Gaspra (asteroid 951)
    public static final int _ORM_GDA_1994 = 75; /// GDA
    public static final int _ORM_GEODETIC_DATUM_1949 = 76; /// Geodetic Datum
    public static final int _ORM_GEOMAGNETIC_1945 = 77; /// Geomagnetic
    public static final int _ORM_GEOMAGNETIC_1950 = 78; /// Geomagnetic
    public static final int _ORM_GEOMAGNETIC_1955 = 79; /// Geomagnetic
    public static final int _ORM_GEOMAGNETIC_1960 = 80; /// Geomagnetic
    public static final int _ORM_GEOMAGNETIC_1965 = 81; /// Geomagnetic
    public static final int _ORM_GEOMAGNETIC_1970 = 82; /// Geomagnetic
    public static final int _ORM_GEOMAGNETIC_1975 = 83; /// Geomagnetic
    public static final int _ORM_GEOMAGNETIC_1980 = 84; /// Geomagnetic
    public static final int _ORM_GEOMAGNETIC_1985 = 85; /// Geomagnetic
    public static final int _ORM_GEOMAGNETIC_1990 = 86; /// Geomagnetic
    public static final int _ORM_GEOMAGNETIC_1995 = 87; /// Geomagnetic
    public static final int _ORM_GEOMAGNETIC_2000 = 88; /// Geomagnetic
    public static final int _ORM_GRACIOSA_BASE_SW_1948 = 89; /// Graciosa Base SW
    public static final int _ORM_GUAM_1963 = 90; /// Guam
    public static final int _ORM_GUNONG_SEGARA_1987 = 91; /// Gunung Segara
    public static final int _ORM_GUX_1_1987 = 92; /// GUX1 (astronomic)
    public static final int _ORM_HELENE_1992 = 93; /// Helene
    public static final int _ORM_HELIO_ARIES_ECLIPTIC_J2000r0 = 94; /// Heliocentric Aries ecliptic, J2000.0
    public static final int _ORM_HELIO_ARIES_ECLIPTIC_TRUE_OF_DATE = 95; /// Heliocentric Aries ecliptic, true of date
    public static final int _ORM_HELIO_EARTH_ECLIPTIC = 96; /// Heliocentric Earth ecliptic
    public static final int _ORM_HELIO_EARTH_EQUATORIAL = 97; /// Heliocentric Earth equatorial
    public static final int _ORM_HERAT_NORTH_1987 = 98; /// Herat North
    public static final int _ORM_HERMANNSKOGEL_1871 = 99; /// Hermannskogel
    public static final int _ORM_HJORSEY_1955 = 100; /// Hjorsey
    public static final int _ORM_HONG_KONG_1963 = 101; /// Hong Kong
    public static final int _ORM_HU_TZU_SHAN_1991 = 102; /// Hu-Tzu-Shan
    public static final int _ORM_IAPETUS_1988 = 103; /// Iapetus
    public static final int _ORM_IDA_1991 = 104; /// Ida (asteroid 243)
    public static final int _ORM_INDIAN_1916 = 105; /// Indian
    public static final int _ORM_INDIAN_1954 = 106; /// Indian
    public static final int _ORM_INDIAN_1956 = 107; /// Indian
    public static final int _ORM_INDIAN_1960 = 108; /// Indian
    public static final int _ORM_INDIAN_1962 = 109; /// Indian
    public static final int _ORM_INDIAN_1975 = 110; /// Indian
    public static final int _ORM_INDONESIAN_1974 = 111; /// Indonesian
    public static final int _ORM_IO_2000 = 112; /// Io
    public static final int _ORM_IRELAND_1965 = 113; /// Ireland 1965
    public static final int _ORM_ISTS_061_1968 = 114; /// International Satellite Triangulation Station (ISTS) 061 (astronomic)
    public static final int _ORM_ISTS_073_1969 = 115; /// International Satellite Triangulation Station (ISTS) 073 (astronomic)
    public static final int _ORM_JANUS_1988 = 116; /// Janus
    public static final int _ORM_JGD_2000 = 117; /// Japanese Geodetic Datum 2000 (JGD2000)
    public static final int _ORM_JOHNSTON_1961 = 118; /// Johnston
    public static final int _ORM_JULIET_1988 = 119; /// Juliet
    public static final int _ORM_JUPITER_1988 = 120; /// Jupiter
    public static final int _ORM_JUPITER_INERTIAL = 121; /// Jupiter equatorial inertial
    public static final int _ORM_JUPITER_MAGNETIC_1993 = 122; /// Jupiter magnetic
    public static final int _ORM_JUPITER_SOLAR_ECLIPTIC = 123; /// Jupiter solar ecliptic
    public static final int _ORM_JUPITER_SOLAR_EQUATORIAL = 124; /// Jupiter solar equatorial
    public static final int _ORM_JUPITER_SOLAR_MAG_DIPOLE = 125; /// Jupiter solar magnetic dipole
    public static final int _ORM_JUPITER_SOLAR_MAG_ECLIPTIC = 126; /// Jupiter solar magnetic ecliptic
    public static final int _ORM_KANDAWALA_1987 = 127; /// Kandawala
    public static final int _ORM_KERGUELEN_1949 = 128; /// Kerguelen
    public static final int _ORM_KERTAU_1948 = 129; /// Kertau
    public static final int _ORM_KOREAN_GEODETIC_1995 = 130; /// Korean Geodetic System
    public static final int _ORM_KUSAIE_1951 = 131; /// Kusaie 1951 (astronomic)
    public static final int _ORM_LARISSA_1991 = 132; /// Larissa
    public static final int _ORM_LC5_1961 = 133; /// LC5 (astronomic)
    public static final int _ORM_LEIGON_1991 = 134; /// Leigon
    public static final int _ORM_LIBERIA_1964 = 135; /// Liberia
    public static final int _ORM_LUZON_1987 = 136; /// Luzon
    public static final int _ORM_M_PORALOKO_1991 = 137; /// M'Poraloko
    public static final int _ORM_MAHE_1971 = 138; /// Mahe
    public static final int _ORM_MARCUS_STATION_1952 = 139; /// Marcus Station (astronomic)
    public static final int _ORM_MARS_2000 = 140; /// Mars
    public static final int _ORM_MARS_INERTIAL = 141; /// Mars equatorial inertial
    public static final int _ORM_MARS_SPHERE_2000 = 142; /// Mars (spherical)
    public static final int _ORM_MASS_1999 = 143; /// MASS
    public static final int _ORM_MASSAWA_1987 = 144; /// Massawa
    public static final int _ORM_MERCHICH_1987 = 145; /// Merchich
    public static final int _ORM_MERCURY_1988 = 146; /// Mercury
    public static final int _ORM_MERCURY_INERTIAL = 147; /// Mercury equatorial inertial
    public static final int _ORM_METIS_2000 = 148; /// Metis
    public static final int _ORM_MIDWAY_1961 = 149; /// Midway 1961 (astronomic)
    public static final int _ORM_MIMAS_1994 = 150; /// Mimas
    public static final int _ORM_MINNA_1991 = 151; /// Minna
    public static final int _ORM_MIRANDA_1988 = 152; /// Miranda
    public static final int _ORM_MM5_1997 = 153; /// MM5 (AFWA)
    public static final int _ORM_MODTRAN_MIDLATITUDE_N_1989 = 154; /// MODTRAN
    public static final int _ORM_MODTRAN_MIDLATITUDE_S_1989 = 155; /// MODTRAN
    public static final int _ORM_MODTRAN_SUBARCTIC_N_1989 = 156; /// MODTRAN
    public static final int _ORM_MODTRAN_SUBARCTIC_S_1989 = 157; /// MODTRAN
    public static final int _ORM_MODTRAN_TROPICAL_1989 = 158; /// MODTRAN
    public static final int _ORM_MONTSERRAT_1958 = 159; /// Montserrat (astronomic)
    public static final int _ORM_MOON_1991 = 160; /// Moon
    public static final int _ORM_MULTIGEN_FLAT_EARTH_1989 = 161; /// Multigen flat Earth
    public static final int _ORM_N_AM_1927 = 162; /// North American
    public static final int _ORM_N_AM_1983 = 163; /// North American
    public static final int _ORM_N_SAHARA_1959 = 164; /// North Sahara
    public static final int _ORM_NAHRWAN_1987 = 165; /// Nahrwan
    public static final int _ORM_NAIAD_1991 = 166; /// Naiad
    public static final int _ORM_NAPARIMA_1991 = 167; /// Naparima BWI
    public static final int _ORM_NEPTUNE_1991 = 168; /// Neptune
    public static final int _ORM_NEPTUNE_INERTIAL = 169; /// Neptune equatorial inertial
    public static final int _ORM_NEPTUNE_MAGNETIC_1993 = 170; /// Neptune magnetic
    public static final int _ORM_NOGAPS_1988 = 171; /// NOGAPS
    public static final int _ORM_NTF_1896 = 172; /// NTF
    public static final int _ORM_NTF_1896_PM_PARIS = 173; /// NTF (with the Prime Meridian at Paris)
    public static final int _ORM_OBERON_1988 = 174; /// Oberon
    public static final int _ORM_OBSERV_METEORO_1939 = 175; /// Observatorio Meteorologico
    public static final int _ORM_OLD_EGYPTIAN_1907 = 176; /// Old Egyptian
    public static final int _ORM_OLD_HAWAIIAN_CLARKE_1987 = 177; /// Old Hawaiian (Clarke)
    public static final int _ORM_OLD_HAWAIIAN_INT_1987 = 178; /// Old Hawaiian (International)
    public static final int _ORM_OPHELIA_1988 = 179; /// Ophelia
    public static final int _ORM_OSGB_1936 = 180; /// Ordnance Survey of Great Britain
    public static final int _ORM_PAN_1991 = 181; /// Pan
    public static final int _ORM_PANDORA_1988 = 182; /// Pandora
    public static final int _ORM_PHOBOS_1988 = 183; /// Phobos
    public static final int _ORM_PHOEBE_1988 = 184; /// Phoebe
    public static final int _ORM_PICO_DE_LAS_NIEVES_1987 = 185; /// Pico de las Nieves
    public static final int _ORM_PITCAIRN_1967 = 186; /// Pitcairn (astronomic)
    public static final int _ORM_PLUTO_1994 = 187; /// Pluto
    public static final int _ORM_PLUTO_INERTIAL = 188; /// Pluto equatorial inertial
    public static final int _ORM_POINT_58_1991 = 189; /// Point 58
    public static final int _ORM_POINTE_NOIRE_1948 = 190; /// Pointe Noire
    public static final int _ORM_PORTIA_1988 = 191; /// Portia
    public static final int _ORM_PORTO_SANTO_1936 = 192; /// Porto Santo
    public static final int _ORM_PROMETHEUS_1988 = 193; /// Prometheus
    public static final int _ORM_PROTEUS_1991 = 194; /// Proteus
    public static final int _ORM_PROV_S_AM_1956 = 195; /// Provisional South American
    public static final int _ORM_PROV_S_CHILEAN_1963 = 196; /// Provisional South Chilean (Hito XVIII)
    public static final int _ORM_PUCK_1988 = 197; /// Puck
    public static final int _ORM_PUERTO_RICO_1987 = 198; /// Puerto Rico
    public static final int _ORM_PULKOVO_1942 = 199; /// Pulkovo
    public static final int _ORM_QATAR_NATIONAL_1974 = 200; /// Qatar National
    public static final int _ORM_QORNOQ_1987 = 201; /// Qornoq
    public static final int _ORM_REUNION_1947 = 202; /// Reunion
    public static final int _ORM_RGF_1993 = 203; /// Reseau Geodesique Francais
    public static final int _ORM_RHEA_1988 = 204; /// Rhea
    public static final int _ORM_ROME_1940 = 205; /// Rome (also known as Monte Mario)
    public static final int _ORM_ROME_1940_PM_ROME = 206; /// Rome (also known as Monte Mario) (with the Prime Meridian at Rome)
    public static final int _ORM_ROSALIND_1988 = 207; /// Rosalind
    public static final int _ORM_S_AM_1969 = 208; /// South American
    public static final int _ORM_S_ASIA_1987 = 209; /// South Asia
    public static final int _ORM_S_JTSK_1993 = 210; /// S-JTSK
    public static final int _ORM_S42_PULKOVO = 211; /// S-42 (Pulkovo)
    public static final int _ORM_SANTO_DOS_1965 = 212; /// Santo (DOS)
    public static final int _ORM_SAO_BRAZ_1987 = 213; /// Sao Braz
    public static final int _ORM_SAPPER_HILL_1943 = 214; /// Sapper Hill
    public static final int _ORM_SATURN_1988 = 215; /// Saturn
    public static final int _ORM_SATURN_INERTIAL = 216; /// Saturn equatorial inertial
    public static final int _ORM_SATURN_MAGNETIC_1993 = 217; /// Saturn magnetic
    public static final int _ORM_SCHWARZECK_1991 = 218; /// Schwarzeck
    public static final int _ORM_SELVAGEM_GRANDE_1938 = 219; /// Selvagem Grande
    public static final int _ORM_SIERRA_LEONE_1960 = 220; /// Sierra Leone
    public static final int _ORM_SIRGAS_2000 = 221; /// SIRGAS
    public static final int _ORM_SUN_1992 = 222; /// Sun
    public static final int _ORM_TANANARIVE_OBS_1925 = 223; /// Tananarive Observatory
    public static final int _ORM_TANANARIVE_OBS_1925_PM_PARIS = 224; /// Tananarive Observatory (with the Prime Meridian at Paris)
    public static final int _ORM_TELESTO_1988 = 225; /// Telesto
    public static final int _ORM_TERN_1961 = 226; /// Tern (astronomic)
    public static final int _ORM_TETHYS_1991 = 227; /// Tethys
    public static final int _ORM_THALASSA_1991 = 228; /// Thalassa
    public static final int _ORM_THEBE_2000 = 229; /// Thebe
    public static final int _ORM_TIMBALAI_EVEREST_1948 = 230; /// Timbali (Everest)
    public static final int _ORM_TITAN_1982 = 231; /// Titan
    public static final int _ORM_TITANIA_1988 = 232; /// Titania
    public static final int _ORM_TOKYO_1991 = 233; /// Tokyo
    public static final int _ORM_TRISTAN_1968 = 234; /// Tristan (astronomic)
    public static final int _ORM_TRITON_1991 = 235; /// Triton
    public static final int _ORM_UMBRIEL_1988 = 236; /// Umbriel
    public static final int _ORM_URANUS_1988 = 237; /// Uranus
    public static final int _ORM_URANUS_INERTIAL = 238; /// Uranus equatorial inertial
    public static final int _ORM_URANUS_MAGNETIC_1993 = 239; /// Uranus magnetic
    public static final int _ORM_VENUS_1991 = 240; /// Venus
    public static final int _ORM_VENUS_INERTIAL = 241; /// Venus equatorial inertial
    public static final int _ORM_VITI_LEVU_1916 = 242; /// Viti Levu
    public static final int _ORM_VOIROL_1874 = 243; /// Voirol
    public static final int _ORM_VOIROL_1874_PM_PARIS = 244; /// Voirol (with the Prime Meridian at Paris)
    public static final int _ORM_VOIROL_1960 = 245; /// Voirol - Revised
    public static final int _ORM_VOIROL_1960_PM_PARIS = 246; /// Voirol - Revised (with the Prime Meridian at Paris)
    public static final int _ORM_WAKE_1952 = 247; /// Wake (astronomic)
    public static final int _ORM_WAKE_ENIWETOK_1960 = 248; /// Wake-Eniwetok
    public static final int _ORM_WGS_1972 = 249; /// World Geodetic System
    public static final int _ORM_WGS_1984 = 250; /// World Geodetic System
    public static final int _ORM_YACARE_1987 = 251; /// Yacare (Uruguay)
    public static final int _ORM_ZANDERIJ_1987 = 252; /// Zanderij (Suriname)
    ...
    public static SRM_ORM_Code getEnum( int e ) throws SrmException
    {
        if( e < 1 || e > _totalEnum )
            throw new SrmException( SrmException._INVALID_INPUT,
                        new String("SRM_ORM_Code.getEnum: enumerant out of range") );
        else
            return (SRM_ORM_Code)(_enumVec.elementAt( e ));
    }

    /// returns the SRM_ORM_Code from its string name
