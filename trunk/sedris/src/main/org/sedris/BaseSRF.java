                ...
                switch (mySrfSet.toInt())
                {
                    case SRM_SRFS_Code._SRFS_ALABAMA_SPCS:
                         retValidity = CoordCheck.forALSP_cd
                                       ...
                                       coord_tgt);
                         break;
                    case SRM_SRFS_Code._SRFS_GTRS_GLOBAL_COORDINATE_SYSTEM:
                    ...
                    case SRM_SRFS_Code._SRFS_JAPAN_RECTANGULAR_PLANE_CS:
                         retValidity = CoordCheck.forJapan_cd
                                       (
                                           new OrmData(this.getOrm()),
                                           (SRM_SRFSM_Japan_RPCS_Code)this.getSRFSetMemberCode(),
                                           ((SRF_TransverseMercator)this).getSRFParameters(),
                                           coord_tgt
                                       );
                         break;
                    case SRM_SRFS_Code._SRFS_LAMBERT_NTF:
                         ...
                         break;
                    case SRM_SRFS_Code._SRFS_UNIVERSAL_POLAR_STEREOGRAPHIC:
                    ...
                    case SRM_SRFS_Code._SRFS_UNIVERSAL_TRANSVERSE_MERCATOR:
                         retValidity = CoordCheck.forUTM_cd
                                       ...
                                       coord_tgt);
                         break;
                    case SRM_SRFS_Code._SRFS_WISCONSIN_SPCS:
        ...
        else
        {
            ...
            if (myBoundaryTemplateSrf == SRM_SRFT_Code.SRFT_CELESTIODETIC)
            {
                ...
                ormData = null;
                     ...
                     myBoundaryTemplateSrf == SRM_SRFT_Code.SRFT_LOCOCENTRIC_EUCLIDEAN_3D)
            {
            ...
            else if (myBoundaryTemplateSrf == SRM_SRFT_Code.SRFT_LOCAL_SPACE_AZIMUTHAL_2D)
            {
                retValidity = CoordCheck.forLocalSpaceAzimuthal2D(src.getValues());
            }
            else if (myBoundaryTemplateSrf == SRM_SRFT_Code.SRFT_LOCAL_SPACE_POLAR_2D)
            {
