...
{ 
	...
	try {
	    ...
	    // longitude           => -116.17 degrees (note: this input parameter is converted to radians)
	    // latitude            => 34.3 degrees (note: this input parameter is converted to radians)
	    // ellipsopidal height => 630.0 meters
        // Near 29 palms, CA, USA. Note usual lat/lon order is reversed.

	    Coord3D_Celestiodetic CdCoord = 
		(Coord3D_Celestiodetic)CdSrf.createCoordinate3D(Math.toRadians(-116.17),
								Math.toRadians(34.3),
								630.0);
