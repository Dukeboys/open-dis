...
public class SRM_SRFSM_GTRS_GCS_Code extends SRM_SRFSM_Code
{
    ...
    private static HashMap _enumLabelMap = new HashMap( );

    private static HashMap _enumCodeMap = new HashMap( );
    ...
    { 
		...
		throw new SrmException( SrmException._INVALID_INPUT,
					new String("SRM_SRFSM_GTRS_GCS_Code: cell id out of range=> [ 1 .. ") );		
	    _SRFSM_GTRS_CELL_ID = cell_id;
    }
    
    /// returns the SRM_SRFSM_GTRS_GCS_Code from its enumerant value
    public static SRM_SRFSM_GTRS_GCS_Code getEnum( int e ) throws SrmException
    {
        if( e < 1 || e > _totalEnum )
            throw new SrmException( SrmException._INVALID_INPUT,
                        new String("SRM_SRFSM_GTRS_GCS_Code.getEnum: enumerant out of range") );

	if ( !_enumCodeMap.containsKey( Integer.toString(e) ) )
	    _enumCodeMap.put( Integer.toString(e), new SRM_SRFSM_GTRS_GCS_Code(e) );
	
	return (SRM_SRFSM_GTRS_GCS_Code)_enumCodeMap.get( Integer.toString(e) );
    }
