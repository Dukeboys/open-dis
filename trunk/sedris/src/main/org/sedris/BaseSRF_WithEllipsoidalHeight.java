...
public abstract class BaseSRF_WithEllipsoidalHeight extends BaseSRF_3D
{
    ...
    */
    ...
    /** Returns the euclidean distance between two coordinates.
        ...
        @return the Euclidean distance between the two CoordSurf coordinates
                (in metres).
    ...
    throws SrmException
    {
        ...
        if (tempCcSrf == null)
            tempCcSrf = new SRF_Celestiocentric(coord1.getSRF().getOrm(),
                                                coord1.getSRF().getRt());
    ...
    /** Returns the geodesic distance between two surface coordinates.
        ...
        @return the geodesic distance between the two surface coordinates
                (in metres)
        @note The input surface coordinates must have been created using
              this SRF.
    */
    ...
    throws SrmException
    {
        ...
        if (tempCdSrf == null)
            tempCdSrf = new SRF_Celestiodetic(this.getOrm(), this.getRt());
...
//                                sin_u1*sin_u2+cos_u1*cos_u2*cos_omega);
        ...
        t = (e2/(1.0-e2))*sinun2*0.25;
        K1 = 1.0+t*(1.0-t*(3.0-t*(5.0-11.0*t))*0.125);
