...
public class Orientation implements Cloneable
{
    ...
    */
	...
	@note The Direction argument must be associated with the same reference coordinate
    */
    public void getDirectionComp( int n, Direction dir ) throws SrmException 
    {
	if ( n < 1 || n > 3 )
	    throw new SrmException( SrmException._INVALID_INPUT, 
    ...
    */
    public void setDirectionComp( Direction dir1, Direction dir2, Direction dir3 ) throws SrmException 
    {
	...
	@note N within [ 1, 2, 3 ]
    */
    public void setDirectionComp( int n, Direction dir ) throws SrmException 
    {
	if ( n < 1 || n > 3 )
	    throw new SrmException( SrmException._INVALID_INPUT, 
