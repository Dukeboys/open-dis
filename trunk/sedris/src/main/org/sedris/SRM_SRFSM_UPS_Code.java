...
public class SRM_SRFSM_UPS_Code extends SRM_SRFSM_Code
{
    ...
    public static final int _SRFSMUPS_UNDEFINED = 0; /// Undefined
    public static final int _SRFSMUPS_NORTHERN_POLE = 1; /// UNIVERSAL_POLAR_STEREOGRAPHIC_NORTHERN_POLE
    public static final int _SRFSMUPS_SOUTHERN_POLE = 2; /// UNIVERSAL_POLAR_STEREOGRAPHIC_SOUTHERN_POLE

    public static final SRM_SRFSM_UPS_Code SRFSMUPS_UNDEFINED
        = new SRM_SRFSM_UPS_Code( _SRFSMUPS_UNDEFINED, "SRFSMUPS_UNDEFINED" );


    public static final SRM_SRFSM_UPS_Code SRFSMUPS_NORTHERN_POLE
        = new SRM_SRFSM_UPS_Code( _SRFSMUPS_NORTHERN_POLE, "SRFSMUPS_NORTHERN_POLE" );
    public static final SRM_SRFSM_UPS_Code SRFSMUPS_SOUTHERN_POLE
        = new SRM_SRFSM_UPS_Code( _SRFSMUPS_SOUTHERN_POLE, "SRFSMUPS_SOUTHERN_POLE" );
    ...
    public static SRM_SRFSM_UPS_Code getEnum( int e ) throws SrmException
    {
        if( e < 1 || e > _totalEnum )
            throw new SrmException( SrmException._INVALID_INPUT,
                        new String("SRM_SRFSM_UPS_Code.getEnum: enumerant out of range") );
        else
            return (SRM_SRFSM_UPS_Code)(_enumVec.elementAt( e ));
    }
