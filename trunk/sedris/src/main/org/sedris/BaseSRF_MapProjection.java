...
public abstract class BaseSRF_MapProjection extends BaseSRF_WithEllipsoidalHeight
{
    ...
    */
                                       ...
                                       double            upper) throws SrmException
    {
        ...
        if (int_interval >= SRM_Interval_Type._GT_SEMI &&
            int_interval <= SRM_Interval_Type._LE_SEMI)
          throw new SrmException(SrmException._INVALID_INPUT,
  ...
  "setValidGeodeticRegion: component 2 (latitude) out of range (-PI/2, PI/2)");
        ...
        if (_component_valid_gd_region[component-1] == null)
            _component_valid_gd_region[component-1] =
                             new SRM_Extended_Valid_Region_Params();
    ...
    /** Set the Extended Valid Geodetic Region for this SRF.
        ...
        @note Upper or Lower value is ignored if the interval is a
              semi-interval or unbounded.
        @note The Lower value must be strictly less than the Upper value.
        @note The Extended_Lower value must be strictly greater than the Lower
              value and the Extended_Upper value must be strictly smaller than
              the Lower value.
        @param component in: the coordinate component (1 or 2)
        @param type in: the type of interval
    ...
    */
    public SRM_Valid_Region_Params getValidGeodeticRegion(int component)
    throws SrmException
    {
        ...
        if (component < 1 || component > 2)
          throw new SrmException(SrmException._INVALID_INPUT,
                "getValidGeodeticRegion: component out of range [ 1, 2 ]");
    ...
    /** Get the Extended Valid Geodetic Region for this SRF.
        ...
        @return the extended valid region parameters
    */
    public SRM_Extended_Valid_Region_Params getExtendedValidGeodeticRegion
                                            (int component)
    throws SrmException
    {
        ...
        if (component < 1 || component > 2)
          throw new SrmException(SrmException._INVALID_INPUT,
          "getExtendedValidGeodeticRegion: component out of range [ 1, 2 ]");
    ...
    */
    ...
    // COM calculations
    abstract protected double comCalculation(OrmData e_constants,
                                             double[] cd_coord)
    throws SrmException;

    // Point Scale calculations
    abstract protected double pointScaleCalculation(OrmData e_constants,
                                                    double[] cd_coord)
    throws SrmException;
}
