...
import edu.nps.moves.disutil.NioServer.Event;
import edu.nps.moves.disutil.PduMulticastReceiver;
import edu.nps.moves.disutil.PduNioMulticastReceiver;
 ...
 * @author rharder
 */
public class PduByteBufferTesterNio extends javax.swing.JFrame implements PduNioMulticastReceiver.Listener {
    ...
    private PduNioMulticastReceiver pduServer;


    /** Creates new form PduByteBufferTester */
    public PduByteBufferTesterNio() {
        initComponents();
        myInitComponents();
    }
    ...
    private void myInitComponents(){
        ...
        this.pduServer = new PduNioMulticastReceiver();
        this.pduServer.addUdpBinding( new InetSocketAddress(62040), "239.1.2.3" );
...
//        this.pduServer.setGroups("239.1.2.3");
        ...
        this.pduServer.addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent evt) {
                ...
                } else if( NioServer.STATE_PROP.equals( evt.getPropertyName() ) ){
        ...
        //this.pduServer.addNioServerListener(this);
...
//        this.pduServer.fireState();
    ...
    public void pduReceived( PduNioMulticastReceiver.Event evt ){
        // Woo Hoo!
        this.recvCount++;
    ...
    private void burstSizeFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_burstSizeFieldFocusLost
        ...
        try {
            ...
            Logger.getLogger(PduByteBufferTesterNio.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//            this.pduServer.addTcpBinding(addr).addUdpBinding(addr,this.recvGroupField.getText());
        ...
        private void startStopButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startStopButtonActionPerformed
            NioServer.State state = this.pduServer.getState();
            switch( state ){
                case STOPPED:
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PduByteBufferTesterNio().setVisible(true);
            }
        });
    }
