    ...
    public void replayExercise()
    {
        try
        {
            ...
            for(int idx = 0; idx < logFiles.length; idx++)
            {
                ...
                List individualLogList = reader.readFromXml(fileName);
                //System.out.println("Got PDU list from log file, length=" + individualLogList.size());
                this.replayList(individualLogList);
            }
