...
public class VariableDatum implements Serializable {
    ...
    public void marshal(DataOutputStream dos) {
        try {
            ...
            dos.writeInt(variableDatums.size() * 64); // post-processing patch to fix units; bits rather than bytes
    ...
    public void marshal(java.nio.ByteBuffer buff) {
        ...
        buff.putInt(  variableDatums.size() * 64);
    ...
    public boolean equals(VariableDatum rhs) {
        ...
        for (int idx = 0; idx < variableDatums.size(); idx++) {
            EightByteChunk x = variableDatums.get(idx);
