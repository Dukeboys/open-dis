...
public class SeesPdu extends DistributedEmissionsFamilyPdu implements Serializable {
     ...
     * @param pNumberOfPropulsionSystems
     */
     ...
     * The method is simply here for java bean completeness.
     * @param pNumberOfVectoringNozzleSystems
     */
    ...
    public boolean equals(SeesPdu rhs) {
        ...
        for (int idx = 0; idx < propulsionSystemData.size(); idx++) {
            PropulsionSystemData x = propulsionSystemData.get(idx);
        ...
        for (int idx = 0; idx < vectoringSystemData.size(); idx++) {
            VectoringNozzleSystemData x = vectoringSystemData.get(idx);
            if (!(x.equals(rhs.vectoringSystemData.get(idx)))) {
                ivarsEqual = false;
            }
        }
