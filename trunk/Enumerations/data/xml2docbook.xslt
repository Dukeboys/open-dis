...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:output method="xml" doctype-system="http://www.oasis-open.org/docbook/xml/4.2/docbookx.dtd"
  ...
  <xsl:strip-space elements="*"/>
		...
		<book>
				...
				<section>
					...
					<para>
						<orderedlist numeration="arabic">
							<listitem>
								<para>
									The URL for the document library containing this document and prior issues, as well as the Change Request form is: <ulink url="http://www.sisostds.org/doclib/doclib.cfm?SISO_RID_1003262">http://www.sisostds.org/doclib/doclib.cfm?SISO_RID_1003262</ulink>
								</para>
							</listitem>
							<listitem>
								<para>
									To subscribe to the e-mail reflector associated with the continued development of this Enumerations document go to <ulink url="http://www.sisostds.org/">http://www.sisostds.org/</ulink>, click on the word Discussions, select SISO-ENUM and click on submit.
								</para>
							</listitem>
						</orderedlist>
					</para>
			...
			<chapter>
				...
				<section>
					...
					<xsl:apply-templates select="enum[@id='pduheader.protocolversion']"/>
				</section>
				...
				<section>
					...
					<xsl:apply-templates select="enum[@id='pduheader.pdutype']"/>
				</section>
				...
				<section>
					...
					<xsl:apply-templates select="enum[@id='pduheader.protocolfamily']"/>
				</section>
			...
			<chapter>
				...
				<section>
					...
					<xsl:apply-templates select="enum[@id='es.forceid']"/>
				</section>
				...
				<section id="es.type">
					...
					<section id="es.type.kind">
						...
						<xsl:apply-templates select="enum[@id='es.type.kind']"/>
						...
						<section>
							...
							<section id="es.type.kind.1.domain">
								...
								<xsl:apply-templates select="enum[@id='es.type.kind.1.domain']"/>
							</section>
							<section>
								<title>Country</title>
							...
							<section>
								...
								<section>
									<title>Land</title>
									<xsl:apply-templates select="enum[@id='es.type.kind.1.domain.1.cat']"/>
								</section>
								<section>
									<title>Air</title>
									<xsl:apply-templates select="enum[@id='es.type.kind.1.domain.2.cat']"/>
								</section>
								<section>
									<title>Surface</title>
									<xsl:apply-templates select="enum[@id='es.type.kind.1.domain.3.cat']"/>
								</section>
								<section>
									<title>Subsurface</title>
									<xsl:apply-templates select="enum[@id='es.type.kind.1.domain.4.cat']"/>
								</section>
								<section>
									<title>Space</title>
									<xsl:apply-templates select="enum[@id='es.type.kind.1.domain.5.cat']"/>
								</section>
							</section>
						</section>
						...
						<section>
							...
							<section>
								...
								<xsl:apply-templates select="enum[@id='es.type.kind.2.domain']"/>
							</section>
							...
							<section>
								...
								<xsl:apply-templates select="enum[@id='es.type.kind.2.cat']"/>
							</section>
                ...
                <section id="es.type.kind.3.subcat">
                  ...
                  <section>
                    ...
                    <xsl:apply-templates select="enum[@id='es.type.225.kind.3.subcat']"/>
                  </section>
                  <section>
                    <title>C.I.S Weapons for Life Forms</title>
                    <xsl:apply-templates select="enum[@id='es.type.222.kind.3.subcat']"/>
                  </section>
                  <section>
                    <title>U.K. Weapons for Life Forms</title>
                    <xsl:apply-templates select="enum[@id='es.type.224.kind.3.subcat']"/>
                  </section>
                  <section>
                    <title>French Weapons for Life Forms</title>
                    <xsl:apply-templates select="enum[@id='es.type.71.kind.3.subcat']"/>
                  </section>
                  <section>
                    <title>German Weapons for Life Forms</title>
                    <xsl:apply-templates select="enum[@id='es.type.78.kind.3.subcat']"/>
                  </section>
                </section>
                ...
                <section>
                  ...
                  <xsl:apply-templates select="enum[@id='es.type.kind.4.subcat']"/>
                </section>
							</section>
						</section>
						...
						<section>
							...
							<section>
								<title>Domain</title>
								<para>
									The Domain field is an 8-bit enumeration. The value is based on the operating domain of the platform carrying the radio. Specific enumerations are defined in <xref linkend="es.type.kind.1.domain"/>.
								</para>
							</section>
							<section>
								<title>Country</title>
								<para>
									The Country field is a 16-bit enumeration defining the radio's country of origin. The defined values for this field are found in <xref linkend="es.type.country"/>.
								</para>
							</section>
							<section>
								<title>Category</title>
								...
								<xsl:apply-templates select="enum[@id='es.type.kind.7.cat']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="enum[@id='es.type.kind.7.version']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="enum[@id='es.type.kind.7.nomenclature']"/>
							</section>
						</section>
						...
						<section>
							...
							<section>
								<title>Domain</title>
								<para>
									The Domain field is an 8-bit enumeration. The defined values for an expendable's domain are identical to a platform's. See <xref linkend="es.type.kind.1.domain"/>.
								</para>
							</section>
							<section>
								<title>Country</title>
								<para>
									The Country field is a 16-bit enumeration defining the expendable's country of origin. The defined values for this field are found in <xref linkend="es.type.country"/>.
								</para>
							</section>
							<section>
								<title>Category</title>
								...
								<section>
									<title>Air</title>
									<xsl:apply-templates select="enum[@id='es.type.kind.8.domain.2.cat']"/>
								</section>
								<section>
									<title>Surface</title>
									<xsl:apply-templates select="enum[@id='es.type.kind.8.domain.3.cat']"/>
								</section>
								<section>
									<title>Subsurface</title>
									<xsl:apply-templates select="enum[@id='es.type.kind.8.domain.4.cat']"/>
								</section>
							</section>
						</section>
						...
						<section>
							...
							<section>
								<title>Domain</title>
								<para>
									The Domain field is an 8-bit enumeration. The defined values for a sensor/emitter's domain are identical to a platform's. See <xref linkend="es.type.kind.1.domain"/>.
								</para>
							</section>
							<section>
								<title>Country</title>
								<para>
									The Country field is a 16-bit enumeration defining a sensor/emitter's country of origin. The defined values for this field are found in <xref linkend="es.type.country"/>.
								</para>
							</section>							
							<section>
								<title>Category</title>
								<para>The Category field is an 8-bit enumeration. The defined values for this field for all domains are: </para>
								<xsl:apply-templates select="enum[@id='es.type.kind.9.cat']"/>
							</section>
							<section>
								<title>Subcategory</title>
								<para>
									The Subcategory-field is an 8-bit enumeration. The defined values for this field for all domains can be found in <xref linkend="der.emission.function"/>.
								</para>
							</section>
						</section>
					...
					<section id="es.type.country">
						...
						<xsl:apply-templates select="enum[@id='es.type.country']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="cet[@id='es.type.cet']"/>
					</section>
				...
				<section>
					...
					<section>
						...
						<section>
							...
							<xsl:apply-templates select="bitmask[@id='es.appear.platform.land']"/>
						</section>
						...
						<section>
							...
							<xsl:apply-templates select="bitmask[@id='es.appear.platform.air']"/>
						</section>
						...
						<section>
							...
							<xsl:apply-templates select="bitmask[@id='es.appear.platform.surface']"/>
						</section>
						...
						<section>
							...
							<xsl:apply-templates select="bitmask[@id='es.appear.platform.subsurface']"/>
						</section>
						...
						<section>
							...
							<xsl:apply-templates select="bitmask[@id='es.appear.platform.space']"/>
						</section>
					...
					<section>
						...
						<xsl:apply-templates select="bitmask[@id='es.appear.environmental']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="bitmask[@id='es.appear.sensoremitter']"/>
					</section>
				</section>
				...
				<section>
					...
					<xsl:apply-templates select="enum[@id='es.dra']"/>
				</section>
				...
				<section>
					...
					<xsl:apply-templates select="enum[@id='es.markingtext']"/>
					<section>
						...
						<section>
							...
							<xsl:apply-templates select="enum[@id='es.markingtext.cctt.div']"/>
						</section>
						<section>
							...
							<section>
								...
								<xsl:apply-templates select="enum[@id='es.markingtext.cctt.1cavunit']"/>
							</section>
							<section>
								<title>Byte 3 - High Level Unit (Byte 2 = 2 - 1st Infantry)</title>
								<xsl:apply-templates select="enum[@id='es.markingtext.cctt.1infunit']"/>
							</section>
						</section>
						<section>
							...
							<section>
								...
								<xsl:apply-templates select="enum[@id='es.markingtext.cctt.company']"/>
							</section>
							<section>
								<title>Byte 5 - Platoon, Section</title>
								<xsl:apply-templates select="enum[@id='es.markingtext.cctt.platoon']"/>
							</section>
							<section>
								<title>Byte 6 and 7 - Vehicle</title>
								<xsl:apply-templates select="enum[@id='es.markingtext.cctt.vehicle']"/>
							</section>
						</section>
						<section>
							...
							<section>
								...
								<xsl:apply-templates select="enum[@id='es.markingtext.cctt.symbol1']"/>
							</section>
							<section>
								<title>Byte 11</title>
								<xsl:apply-templates select="enum[@id='es.markingtext.cctt.symbol2']"/>
								<para>
					...
					<section>
						...
						<section>
							...
							<xsl:apply-templates select="enum[@id='es.markingtext.chevron.symbol']"/>
						</section>
					</section>					
				</section>
				...
				<section>
					...
					<xsl:apply-templates select="bitmask[@id='es.capabilities']"/>
				</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='es.vp.type']"/>
						<section id="es.vp.type.1.attached">
							...
							<xsl:apply-templates select="enum[@id='es.vp.type.1.attached']"/>
						</section>
						<section>
							...
							<section>
								...
								<xsl:apply-templates select="enum[@id='es.vp.type.0.articulated.offset']"/>
							</section>
							<section id="es.vp.type.0.articulated.index">
								<title>Articulated parts index number</title>
								<xsl:apply-templates select="enum[@id='es.vp.type.0.articulated.index']"/>
							</section>
							<section>
								...
								<informaltable>
									<tgroup cols="2">
										<tbody>
											...
											<row>
												<entry>Parameter #1 type:</entry><entry>4107</entry>
											</row>
											<row>
												<entry>Parameter value:</entry><entry>(an angle in radian)</entry>
											</row>
										</tbody>
									</tgroup>
								</informaltable>
			...
			<chapter>
				...
				<section>
					...
					<section id="warfare.burstdescriptor.warhead">
						...
						<xsl:apply-templates select="enum[@id='warfare.burstdescriptor.warhead']"/>
					</section>

					<section id="warfare.burstdescriptor.fuse">
						<title>Fuse (detonator)</title>
						<para>Values for this field are:</para>
						<xsl:apply-templates select="enum[@id='warfare.burstdescriptor.fuse']"/>
					</section>
				</section>
				...
				<section>
					...
					<xsl:apply-templates select="enum[@id='warfare.detonationresult']"/>
				</section>
			...
			<chapter>
				...
				<section>
					...
					<xsl:apply-templates select="enum[@id='log.servicerequest']"/>
				</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='log.repaircomplete.general']"/>
					</section>


					<section>
						<title>Drive train</title>
						<xsl:apply-templates select="enum[@id='log.repaircomplete.drivetrain']"/>
					</section>


					<section>
						<title>Hull/Airframe/B</title>
						<xsl:apply-templates select="enum[@id='log.repaircomplete.hull']"/>
					</section>


					<section>
						<title>Interfaces with environment</title>
						<xsl:apply-templates select="enum[@id='log.repaircomplete.environment']"/>
					</section>


					<section>
						<title>Weapons</title>
						<xsl:apply-templates select="enum[@id='log.repaircomplete.weapons']"/>
					</section>


					<section>
						<title>Fuel systems</title>
						<xsl:apply-templates select="enum[@id='log.repaircomplete.fuelsystem']"/>
					</section>


					<section>
						<title>Electronics</title>
						<xsl:apply-templates select="enum[@id='log.repaircomplete.electronics']"/>
					</section>


					<section>
						<title>Life support systems</title>
						<xsl:apply-templates select="enum[@id='log.repaircomplete.lifesupport']"/>
					</section>


					<section>
						<title>Hydraulic systems and actuators</title>
						<xsl:apply-templates select="enum[@id='log.repaircomplete.hydraulic']"/>
					</section>


					<section>
						<title>Auxiliary craft</title>
						<xsl:apply-templates select="enum[@id='log.repaircomplete.auxilary']"/>
					</section>
				...
				<section>
					...
					<xsl:apply-templates select="enum[@id='log.repairresponse']"/>
				</section>
			...
			<chapter>
				...
				<section>
					...
					<xsl:apply-templates select="enum[@id='simman.datumid']"/>
				</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='simman.stop.reason']"/>
					</section>
					<section>
						...
						<xsl:apply-templates select="bitmask[@id='simman.stop.frozenbehavior']"/>
					</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='simman.ack.ackflag']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='simman.ack.responseflag']"/>
					</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='simman.actionrequest.actionid']"/>
					</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='simman.actionresponse.status']"/>
					</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='simman.eventreport.eventtype']"/>
					</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='simman.reliability.service']"/>
					</section>
			...
			<chapter>
				...
				<section>
					...
					<section>
						...
						<section>
							...
							<xsl:apply-templates select="enum[@id='der.emission.name.electro']"/>
						</section>

						<section>
							<title>Acoustic emitters</title>
							<xsl:apply-templates select="enum[@id='der.emission.name.acoustic']"/>
						</section>

						<section>
							<title>Acoustic emitters</title>
							<xsl:apply-templates select="enum[@id='der.emission.name.other']"/>
						</section>
					...
					<section id="der.emission.function">
						...
						<xsl:apply-templates select="enum[@id='der.emission.function']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='der.emission.stateupdate']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='der.emission.beamfunction']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='der.emission.hdtj']"/>
					</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='der.designator.codename']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='der.designator.code']"/>
					</section>
          ...
          <section>
            ...
            <section>
              ...
              <xsl:apply-templates select="enum[@id='der.iff.type']"/>
            </section>
            <section>
              ...
              <xsl:apply-templates select="enum[@id='der.iff.name']"/>
            </section>
            <section>
              ...
              <xsl:apply-templates select="enum[@id='der.iff.mode']"/>
            </section>
          </section>
            ...
            <section>
              ...
              <section>
                ...
                <xsl:apply-templates select="bitmask[@id='der.iff.type.1.changeoptions']"/>
              </section>
            </section>
						<section>
							...
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='der.iff.fop.status']"/>
							</section>
							<section>
								<title>Parameter 1 - Mode 1 Code/Status</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.1.fop.param1']"/>
							</section>
							<section>
								<title>Parameter 2 - Mode 2 Code/Status</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.1.fop.param2']"/>
							</section>
							<section>
								<title>Parameter 3 - Mode 3 Code/Status</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.1.fop.param3']"/>
							</section>
							<section>
								<title>Parameter 4 - Mode 4 Code/Status</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.1.fop.param4']"/>
							</section>
							<section>
								<title>Parameter 5 - Mode C Code/Status</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.1.fop.param5']"/>
							</section>
							<section>
								<title>Parameter 6 - Mode S Code/Status</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.1.fop.param6']"/>
							</section>
							<section>
								<title>Modifier</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.1.fop.modifier']"/>
							</section>
							<section>
								<title>Alternate Parameter 4</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.1.fop.altp4']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='der.iff.infolayers']"/>
							</section>
						</section>
						<section>
							...
							<section>
								...
								<xsl:apply-templates select="enum[@id='der.iff.layerspecific']"/>
							</section>
						</section>
						<section>
							...
							<section>
								...
								<xsl:apply-templates select="enum[@id='der.iff.type.1.sop.param1']"/>
							</section>
							<section>
								<title>Operational Parameter 2</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.1.sop.param2']"/>
							</section>
						</section>
					</section>
					...
					<section>
						...
						<section>
							...
							<section>
								<title>Change/Options</title>
								<para>This section specifies the 8-bit Boolean array for the Change/Options field in the System ID record of the IFF/ATC/NAVAIDS PDU.</para>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.2.changeoptions']"/>
							</section>
						</section>
						<section>
							<title>Fundamental Operational Data</title>
							...
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='der.iff.type.2.fop.param1']"/>
							</section>
							<section>
								<title>Parameter 2 - Mode 2 Interrogator Status</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.2.fop.param2']"/>
							</section>
							<section>
								<title>Parameter 3 - Mode 3 Interrogator Status</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.2.fop.param3']"/>
							</section>
							<section>
								<title>Parameter 4 - Mode 4 Interrogator Status</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.2.fop.param4']"/>
							</section>
							<section>
								<title>Parameter 5 - Mode C Interrogator Status</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.2.fop.param5']"/>
							</section>
							<section>
								<title>Parameter 6 - Mode S Code/Status</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.2.fop.param6']"/>
							</section>
							<section>
								<title>Modifier</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.2.fop.modifier']"/>
							</section>
							<section>
								<title>Alternate Parameter 4</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.2.fop.altp4']"/>
							</section>
							<section>
								<title>Information Layers</title>
								<para>This section specifies the 8-bit Boolean array for the Information Layer Field in the Fundamental Operational Data record of the IFF/ATC/NAVAIDS PDU.</para>
						...
						<section>
							...
							<section>
								<title>Operational Parameter 1</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.2.sop.param1']"/>
							</section>
							<section>
								<title>Operational Parameter 2</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.2.sop.param2']"/>
							</section>
						</section>
					</section>
					...
					<section>
						...
						<section>
							...
							<section>
								<title>Change/Options</title>
								<para>This section specifies the 8-bit Boolean array for the Change/Options field in the System ID record of the IFF/ATC/NAVAIDS PDU.</para>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.3.changeoptions']"/>
							</section>
						</section>
						<section>
							<title>Fundamental Operational Data</title>
							...
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='der.iff.type.3.fop.param1']"/>
							</section>
							<section>
								<title>Parameter 2</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.3.fop.param2']"/>
							</section>
							<section>
								<title>Parameter 3</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.3.fop.param3']"/>
							</section>
							<section>
								<title>Parameter 4</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.3.fop.param4']"/>
							</section>
							<section>
								<title>Parameter 5</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.3.fop.param5']"/>
							</section>
							<section>
								<title>Parameter 6</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.3.fop.param6']"/>
							</section>
							<section>
								<title>Modifier</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.3.fop.modifier']"/>
							</section>
							<section>
								<title>Alternate Parameter 4</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.3.fop.altp4']"/>
							</section>
							<section>
								<title>Information Layers</title>
								<para>This section specifies the 8-bit Boolean array for the Information Layer Field in the Fundamental Operational Data record of the IFF/ATC/NAVAIDS PDU.</para>
						...
						<section>
							...
							<section>
								<title>Operational Parameter 1</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.3.sop.param1']"/>
							</section>
							<section>
								<title>Operational Parameter 2</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.3.sop.param2']"/>
							</section>
						</section>
					</section>
					...
					<section>
						...
						<section>
							...
							<section>
								<title>Change/Options</title>
								<para>This section specifies the 8-bit Boolean array for the Change/Options field in the System ID record of the IFF/ATC/NAVAIDS PDU.</para>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.4.changeoptions']"/>
							</section>
						</section>
						<section>
							<title>Fundamental Operational Data</title>
							...
							<section>
								<title>Parameter 1</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.4.fop.param1']"/>
							</section>
							<section>
								<title>Parameter 2</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.4.fop.param2']"/>
							</section>
							<section>
								<title>Parameter 3</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.4.fop.param3']"/>
							</section>
							<section>
								<title>Parameter 4</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.4.fop.param4']"/>
							</section>
							<section>
								<title>Parameter 5</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.4.fop.param5']"/>
							</section>
							<section>
								<title>Parameter 6</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.4.fop.param6']"/>
							</section>
							<section>
								<title>Modifier</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.4.fop.modifier']"/>
							</section>
							<section>
								<title>Alternate Parameter 4</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.4.fop.altp4']"/>
							</section>
							<section>
								<title>Information Layers</title>
								<para>This section specifies the 8-bit Boolean array for the Information Layer Field in the Fundamental Operational Data record of the IFF/ATC/NAVAIDS PDU.</para>
						...
						<section>
							...
							<section>
								<title>Operational Parameter 1</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.4.sop.param1']"/>
							</section>
							<section>
								<title>Operational Parameter 2</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.4.sop.param2']"/>
							</section>
						</section>
					</section>
					...
					<section>
						...
						<section>
							...
							<section>
								<title>Change/Options</title>
								<para>This section specifies the 8-bit Boolean array for the Change/Options field in the System ID record of the IFF/ATC/NAVAIDS PDU.</para>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.5.changeoptions']"/>
							</section>
						</section>
						<section>
							<title>Fundamental Operational Data</title>
							...
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='der.iff.type.5.fop.param1']"/>
							</section>
							<section>
								<title>Parameter 2</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.5.fop.param2']"/>
							</section>
							<section>
								<title>Parameter 3</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.5.fop.param3']"/>
							</section>
							<section>
								<title>Parameter 4</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.5.fop.param4']"/>
							</section>
							<section>
								<title>Parameter 5</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.5.fop.param5']"/>
							</section>
							<section>
								<title>Parameter 6</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.5.fop.param6']"/>
							</section>
							<section>
								<title>Modifier</title>
								<xsl:apply-templates select="bitmask[@id='der.iff.type.5.fop.modifier']"/>
							</section>
							<section>
								<title>Alternate Parameter 4</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.5.fop.altp4']"/>
							</section>
							<section>
								<title>Information Layers</title>
								<para>This section specifies the 8-bit Boolean array for the Information Layer Field in the Fundamental Operational Data record of the IFF/ATC/NAVAIDS PDU.</para>
						...
						<section>
							...
							<section>
								<title>Operational Parameter 1</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.5.sop.param1']"/>
							</section>
							<section>
								<title>Operational Parameter 2</title>
								<xsl:apply-templates select="enum[@id='der.iff.type.5.sop.param2']"/>
							</section>
						</section>
					</section>
              ...
              <orderedlist numeration="arabic">
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='der.ua.statechangeupdate']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='der.ua.systemname']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='der.ua.function']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='der.ua.activeparameterindex']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='der.ua.scanpattern']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='der.ua.passiveparameterindex']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="bitmask[@id='der.ua.ppcfg']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='der.ua.apaparameterindex']"/>
					</section>
				...
				<section>
					...
					<section>
						...
						<section>
							...
							<xsl:apply-templates select="enum[@id='der.sees.power.aircraft']"/>
						</section>


						<section>
							<title>Helicopters</title>
							<xsl:apply-templates select="enum[@id='der.sees.power.helicopters']"/>
						</section>


						<section>
							<title>Tanks</title>
							<xsl:apply-templates select="enum[@id='der.sees.power.tanks']"/>
						</section>
				...
				<section>
					...
					<section>
						...
						<section>
							...
							<xsl:apply-templates select="bitmask[@id='radio.tx.mod.spreadspectrum']"/>
						...
						<section>
							...
							<xsl:apply-templates select="enum[@id='radio.tx.mod.major']"/>
						</section>
						...
						<section>
							...
							<section>
								...
								<xsl:apply-templates select="enum[@id='radio.tx.mod.major.1.detail']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="enum[@id='radio.tx.mod.major.2.detail']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="enum[@id='radio.tx.mod.major.3.detail']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="enum[@id='radio.tx.mod.major.4.detail']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="enum[@id='radio.tx.mod.major.5.detail']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="enum[@id='radio.tx.mod.major.6.detail']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="enum[@id='radio.tx.mod.major.7.detail']"/>
							</section>
						</section>
						...
						<section>
							...
							<xsl:apply-templates select="enum[@id='radio.tx.mod.system']"/>
						</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='radio.tx.state']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='radio.tx.inputsource']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='radio.tx.cryptosystem']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='radio.tx.antennapatterntype']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='radio.tx.referencesystem']"/>
					</section>
          ...
          <section>
              ...
              <xsl:apply-templates select="record[@id='radio.tx.modparam.cctt']"/>
							<section>
								...
								<xsl:apply-templates select="enum[@id='radio.tx.param.cctt.start']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="enum[@id='radio.tx.param.cctt.clear']"/>
							</section>
						</section>
              ...
              <xsl:apply-templates select="record[@id='radio.tx.modparam.jtids']"/>
							<section>
								...
								<xsl:apply-templates select="enum[@id='radio.tx.param.jtids.mode1']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="enum[@id='radio.tx.param.jtids.mode2']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="enum[@id='radio.tx.param.jtids.sync']"/>
							</section>
						</section>
					...
					<section>
						...
						<xsl:apply-templates select="bitmask[@id='radio.tx.encoding']"/>
					</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='radio.rx.state']"/>
					</section>
				</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='radio.ic.controltype']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='radio.ic.transmitstate']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='radio.ic.deststate']"/>
					</section>
					...
					<section>
						...
						<section>
							...
							<xsl:apply-templates select="enum[@id='radio.ic.param.type']"/>
						</section>
            <section id="radio.ic.paramrecords">
              ...
              <section>
                ...
                <xsl:apply-templates select="record[@id='radio.ic.paramrecords.dest']"/>
              </section>
              <section>
                ...
                <xsl:apply-templates select="record[@id='radio.ic.paramrecords.groupdest']"/>
              </section>
              <section>
                ...
                <xsl:apply-templates select="record[@id='radio.ic.paramrecords.gassign']"/>
              </section>
            </section>
					</section>
				</section>
			...
			<chapter>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='entity.collision.type']"/>
					</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="bitmask[@id='entity.mine.appear']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="bitmask[@id='entity.mine.datafilter']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="bitmask[@id='entity.mine.fusing']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='entity.mine.sensortype']"/>
						<section>
							<title>Optical subcategory</title>
							<xsl:apply-templates select="enum[@id='entity.mine.sensortype.1.subcat']"/>
						</section>
						<section>
							<title>FLIR subcategory</title>
							<xsl:apply-templates select="enum[@id='entity.mine.sensortype.2.subcat']"/>
						</section>
						<section>
							<title>RADAR subcategory</title>
							<xsl:apply-templates select="enum[@id='entity.mine.sensortype.3.subcat']"/>
						</section>
						<section>
							<title>Magnetic subcategory</title>
							<xsl:apply-templates select="enum[@id='entity.mine.sensortype.4.subcat']"/>
						</section>
						<section>
							<title>Laser subcategory</title>
							<xsl:apply-templates select="enum[@id='entity.mine.sensortype.5.subcat']"/>
						</section>
						<section>
							<title>SONAR subcategory</title>
							<xsl:apply-templates select="enum[@id='entity.mine.sensortype.6.subcat']"/>
						</section>
						<section>
							<title>Physical subcategory</title>
							<xsl:apply-templates select="enum[@id='entity.mine.sensortype.7.subcat']"/>
						</section>
						<section>
							<title>Multispectral subcategory</title>
							<xsl:apply-templates select="enum[@id='entity.mine.sensortype.8.subcat']"/>
						</section>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="bitmask[@id='entity.mine.paintscheme']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="bitmask[@id='entity.mine.protocolmode']"/>
					</section>
			...
			<chapter>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='eman.aggregate.state']"/>
					</section>

					<section>
						<title>Formation</title>
						<para>This section specifies the 32-bit enumeration for the Formation-field in the Aggregate State PDU</para>
						<xsl:apply-templates select="enum[@id='eman.aggregate.formation']"/>
					</section>
					...
					<section>
						...
						<section>
							...
							<xsl:apply-templates select="enum[@id='eman.aggregate.type.kind']"/>
						</section>
              ...
              <para>The Category field enumerations for Kind-field = Military Hierarchy specify the Echelon Level of the aggregate, and are enumerated as follows:</para>
							<xsl:apply-templates select="cet[@id='eman.aggregate.type.types']"/>
							...
							<section>
								...
								<xsl:apply-templates select="enum[@id='eman.aggregate.type.subcategory']"/>
							</section>
							...
							<section>
								...
								<xsl:apply-templates select="enum[@id='eman.aggregate.type.specific']"/>
							</section>
						</section>
					</section>
				</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='eman.ispartof.nature']"/>
					</section>
  				<section id="eman.ispartof.position">
						...
						<xsl:apply-templates select="enum[@id='eman.ispartof.position']"/>
					</section>
					<section>
						...
						<xsl:apply-templates select="enum[@id='eman.ispartof.stationname']"/>
					</section>
				</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='eman.isgroupof.category']"/>
					</section>
					<section>
						...
						<xsl:apply-templates select="enum[@id='eman.isgroupof.reststatus']"/>
					</section>
					<section>
              ...
              <xsl:apply-templates select="record[@id='eman.isgroupof.record1']"/>
						</section>
						<section>
              ...
              <xsl:apply-templates select="record[@id='eman.isgroupof.record2']"/>
						</section>
						<section>
              ...
              <xsl:apply-templates select="record[@id='eman.isgroupof.record3']"/>
						</section>
            <section>
              ...
              <xsl:apply-templates select="record[@id='eman.isgroupof.record4']"/>
            </section>
						<section>
              ...
              <xsl:apply-templates select="record[@id='eman.isgroupof.record5']"/>
						</section>
						<section>
              ...
              <xsl:apply-templates select="record[@id='eman.isgroupof.record6']"/>
						</section>
            <section>
              ...
              <xsl:apply-templates select="record[@id='eman.isgroupof.record7']"/>
            </section>
            <section>
              ...
              <xsl:apply-templates select="record[@id='eman.isgroupof.record8']"/>
						</section>
						<section>
              ...
              <xsl:apply-templates select="record[@id='eman.isgroupof.record9']"/>
						</section>
					</section>
				</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='eman.tc.transfertype']"/>
					</section>
				</section>
				...
				<section>
					...
					<section>
						...
						<section>
							<title>Domain</title>
							<para>
								The domain enumerations are the same as used for the Entity Type record (see <xref linkend="es.type"/>).
							</para>
						</section>
						<section>
							<title>Object Kind</title>
							<para>This section specifies the 8-bit enumeration for the Object Kind field.</para>
							<xsl:apply-templates select="enum[@id='env.obj.objecttype.kind']"/>
						</section>
						<section>
							<title>Point Object State PDU Object Types</title>
              <xsl:apply-templates select="cot[@id='env.obj.objecttype.point']"/>
						</section>
            <section>
              <title>Linear Object State PDU Object Types</title>
              <xsl:apply-templates select="cot[@id='env.obj.objecttype.linear']"/>
            </section>
            <section>
              <title>Areal Object State PDU Object Types</title>
              <xsl:apply-templates select="cot[@id='env.obj.objecttype.areal']"/>
            </section>
          </section>
					...
					<section>
						...
						<section>
							<title>General</title>
							<xsl:apply-templates select="bitmask[@id='env.obj.appear.general']"/>
						</section>
						<section>
							...
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='env.obj.appear.point.building']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='env.obj.appear.point.breach']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='env.obj.appear.point.burst']"/>
							</section>
							<section>
								<title>Crater</title>
								<para>The upper 32 bits of the Point Object Appearance field for the category Crater are defined as follows:</para>
								<xsl:apply-templates select="bitmask[@id='env.obj.appear.point.crater']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='env.obj.appear.point.bridge']"/>
							</section>
						</section>
						<section>
							...
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='env.obj.appear.linear.tankditch']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='env.obj.appear.linear.exhaust']"/>
							</section>
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='env.obj.appear.linear.marker']"/>
							</section>
							<section>
								<title>Breach</title>
								<para>The upper 32 bits of the Linear Object Appearance field for the category Breach are defined as follows:</para>
								<xsl:apply-templates select="bitmask[@id='env.obj.appear.linear.breach']"/>
							</section>
						</section>
						<section>
							...
							<section>
								...
								<xsl:apply-templates select="bitmask[@id='env.obj.appear.areal.minefield']"/>
							</section>
						</section>
					</section>
					...
					<section>
						...
						<section>
							...
							<xsl:apply-templates select="bitmask[@id='env.obj.mod.point']"/>
						</section>
						<section>
							...
							<xsl:apply-templates select="bitmask[@id='env.obj.mod.linear']"/>
						</section>
						<section>
							...
							<xsl:apply-templates select="bitmask[@id='env.obj.mod.areal']"/>
						</section>
					</section>
				</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='env.gridded.fieldnumber']"/>
					</section>
					<section>
						...
						<xsl:apply-templates select="enum[@id='env.gridded.coordinatesystem']"/>
					</section>
					<section>
						...
						<xsl:apply-templates select="enum[@id='env.gridded.constantgrid']"/>
					</section>
					<section>
						...
						<xsl:apply-templates select="enum[@id='env.gridded.sampletype']"/>
					</section>
					<section>
						<title>Data Representation</title>
						<para>This section specifies the 16-bit enumeration for the Data Representation field of the Grid Data Record.</para>
						<xsl:apply-templates select="enum[@id='env.gridded.datarepresentation']"/>
					</section>
				</section>
				...
				<section>
					...
					<section>
						...
						<xsl:apply-templates select="enum[@id='env.process.modeltype']"/>
					</section>
					...
					<section>
						...
						<xsl:apply-templates select="bitmask[@id='env.process.environmentstatus']"/>
					</section>
					...
					<section>
						...
						<section>
							...
							<xsl:apply-templates select="enum[@id='env.process.type.geometryrecord']"/>
						</section>
						<section>
							<title>Type field values for State record</title>
							<xsl:apply-templates select="enum[@id='env.process.type.staterecord']"/>
						</section>
					</section>
					<section>
              ...
              <xsl:apply-templates select="record[@id='env.process.geom.point1']"/>
						</section>
						<section>
							<title>Point Record 2</title>
              <xsl:apply-templates select="record[@id='env.process.geom.point2']"/>
						</section>
						<section>
							<title>Line Record 1</title>
              <xsl:apply-templates select="record[@id='env.process.geom.line1']"/>
						</section>
						<section>
							<title>Line Record 2</title>
              <xsl:apply-templates select="record[@id='env.process.geom.line2']"/>
						</section>
						<section>
							<title>Bounding Sphere Record</title>
              <xsl:apply-templates select="record[@id='env.process.geom.boundingsphere']"/>
						</section>
						<section>
							<title>Sphere Record 1</title>
              <xsl:apply-templates select="record[@id='env.process.geom.sphere1']"/>
						</section>
						<section>
							<title>Sphere Record 2</title>
              <xsl:apply-templates select="record[@id='env.process.geom.sphere2']"/>
						</section>
						<section>
							<title>Ellipsoid Record 1</title>
              <xsl:apply-templates select="record[@id='env.process.geom.ellipsoid1']"/>
            </section>
            <section>
              <title>Ellipsoid Record 2</title>
              <xsl:apply-templates select="record[@id='env.process.geom.ellipsoid2']"/>
						</section>
						<section>
							<title>Cone Record 1</title>
              <xsl:apply-templates select="record[@id='env.process.geom.cone1']"/>
            </section>
            <section>
              <title>Cone Record 2</title>
              <xsl:apply-templates select="record[@id='env.process.geom.cone2']"/>
						</section>
						<section>
							<title>Rectangular Volume Record 1</title>
              <xsl:apply-templates select="record[@id='env.process.geom.rect1']"/>
            </section>
            <section>
              <title>Rectangular Volume Record 2</title>
              <xsl:apply-templates select="record[@id='env.process.geom.rect2']"/>
						</section>
						<section>
							<title>Gaussian Plume Record</title>
              <xsl:apply-templates select="record[@id='env.process.geom.gplume']"/>
						</section>
						<section>
							<title>Gaussian Puff Record</title>
              <xsl:apply-templates select="record[@id='env.process.geom.gpuff']"/>
						</section>
						<section>
							<title>Uniform Geometry Record</title>
              <xsl:apply-templates select="record[@id='env.process.geom.uniform']"/>
						</section>
						<section>
							<title>Rectangular Volume Record 3</title>
              <xsl:apply-templates select="record[@id='env.process.geom.rect3']"/>
						</section>
					</section>
					<section>
              ...
              <xsl:apply-templates select="record[@id='env.process.state.combic']"/>
						</section>
						<section>
							<title>Flare State</title>
              <xsl:apply-templates select="record[@id='env.process.state.flare']"/>
						</section>
					</section>
				</section>
			</chapter>
	...
	<xsl:template match="acronyms" >
		<para>
			<informaltable>
				<tgroup cols="2">
					<colspec colnum="1" colwidth="75pc"></colspec>
					<tbody>
        ...
        <section>
          <title>
            <xsl:if test="$thiscountry>0">
              <xsl:value-of select="/ebv/enum[@id='es.type.country']/enumrow[@id=$thiscountry]/@description"/>
              <xsl:text> </xsl:text>
            </xsl:if>
            <xsl:value-of select="/ebv/enum[@id='es.type.kind']/enumrow[@id=$thiskind]/@description"/>
          </title>
		  <xsl:apply-templates select="../*[(@kind=$thiskind) and (@country=$thiscountry)]" mode="dotable"/>
        </section>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
        ...
        <tbody>
          ...
          <row>
            <entry namest="c1" nameend="c2" align="center">
              <emphasis>
                <xsl:value-of select="@name"/><xsl:text> - total size </xsl:text> <xsl:value-of select="@length"/><xsl:text> bits</xsl:text>
              </emphasis>
            </entry>
          </row>
        </tbody>
