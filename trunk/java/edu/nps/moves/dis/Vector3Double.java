 ...
 * 1.4_sed_bait_start */
 public Vector3Double(edu.nps.moves.jaxb.dis.Vector3Double x)
 {
     this.x = x.getX();
     this.y = x.getY();
     this.z = x.getZ();
 ...
 * 1.4_sed_bait_start **/
 public edu.nps.moves.jaxb.dis.Vector3Double initializeJaxbObject(edu.nps.moves.jaxb.dis.Vector3Double x)
 {
