 ...
 * 1.4_sed_bait_start */
 public ActionRequestReliablePdu(edu.nps.moves.jaxb.dis.ActionRequestReliablePdu x)
 {
 ...
 * 1.4_sed_bait_start **/
 public edu.nps.moves.jaxb.dis.ActionRequestReliablePdu initializeJaxbObject(edu.nps.moves.jaxb.dis.ActionRequestReliablePdu x)
 {
     ...
     x.setActionID( this.getActionID() );
