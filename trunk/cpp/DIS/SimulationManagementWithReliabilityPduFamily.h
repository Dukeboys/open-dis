#ifndef SIMULATIONMANAGEMENTWITHRELIABILITYPDUFAMILY_H
#define SIMULATIONMANAGEMENTWITHRELIABILITYPDUFAMILY_H
...
class EXPORT_MACRO SimulationManagementWithReliabilityPduFamily : public Pdu
{
protected:
 ...
 public:
    SimulationManagementWithReliabilityPduFamily();
    virtual ~SimulationManagementWithReliabilityPduFamily();
...
virtual int getMarshalledSize() const;
     ...
     bool operator  ==(const SimulationManagementWithReliabilityPduFamily& rhs) const;
};
}
