#ifndef ELECTRONICEMMISIONSPDU_H
#define ELECTRONICEMMISIONSPDU_H
...
class EXPORT_MACRO ElectronicEmmisionsPdu : public DistributedEmissionsPdu
{
protected:
 ...
 public:
    ElectronicEmmisionsPdu();
    virtual ~ElectronicEmmisionsPdu();
...
virtual int getMarshalledSize() const;
     ...
     bool operator  ==(const ElectronicEmmisionsPdu& rhs) const;
};
}
