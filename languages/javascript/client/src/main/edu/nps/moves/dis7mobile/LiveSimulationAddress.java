...
public void setLiveApplicationNumber(int pLiveApplicationNumber)
...
public void marshal(DataOutputStream dos)
{
    try 
    {
       ...
       dos.writeShort( (short)liveApplicationNumber);
    } // end try 
    catch(Exception e)
    { 
...
public void unmarshal(DataInputStream dis)
{
    try 
    {
       ...
       liveApplicationNumber = (int)dis.readUnsignedShort();
    } // end try 
   catch(Exception e)
    { 
      System.out.println(e); 
...
public void marshal(java.nio.ByteBuffer buff)
{
       ...
       buff.putShort( (short)liveApplicationNumber);
    } // end of marshal method
...
public void unmarshal(java.nio.ByteBuffer buff)
{
       ...
       liveApplicationNumber = (int)(buff.getShort() & 0xFFFF);
 } // end of unmarshal method 
