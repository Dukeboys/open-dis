...
public class IOCommunicationsNode extends Object implements Serializable
{
   ...
   protected EntityID  communicationsNode = new EntityID(); 
...
public int getMarshalledSize()
{
   ...
   marshalSize = marshalSize + communicationsNode.getMarshalledSize();  // communicationsNode
...
public void setCommunicationsNode(EntityID pCommunicationsNode)
{ communicationsNode = pCommunicationsNode;
}

public EntityID getCommunicationsNode()
{ return communicationsNode; 
}
...
public void marshal(DataOutputStream dos)
{
    try 
    {
       ...
       communicationsNode.marshal(dos);
...
public void unmarshal(DataInputStream dis)
{
    try 
    {
       ...
       communicationsNode.unmarshal(dis);
...
public void marshal(java.nio.ByteBuffer buff)
{
       ...
       communicationsNode.marshal(buff);
...
public void unmarshal(java.nio.ByteBuffer buff)
{
       ...
       communicationsNode.unmarshal(buff);
...
@Override
 ...
 public boolean equalsImpl(Object obj)
 {
    ...
    if(!(obj instanceof IOCommunicationsNode))
     ...
     if( ! (communicationsNode.equals( rhs.communicationsNode) )) ivarsEqual = false;
