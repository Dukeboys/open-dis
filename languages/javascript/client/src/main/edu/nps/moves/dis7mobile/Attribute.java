...
public void setRecordLength(short pRecordLength)
...
public void marshal(DataOutputStream dos)
{
    try 
    {
       ...
       dos.writeByte( (byte)recordLength);
...
public void unmarshal(DataInputStream dis)
{
    try 
    {
       ...
       recordLength = (short)dis.readUnsignedByte();
...
public void unmarshal(java.nio.ByteBuffer buff)
{
       ...
       recordLength = (short)(buff.get() & 0xFF);
