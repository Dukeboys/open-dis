...
namespace OpenDis.Enumerations.Entity.Information.Minefield
{
    ...
    public struct Appearance
    {
        ...
        public static Appearance FromUInt16(ushort value)
        {
            ...
            ps.MinefieldType = (Appearance.MinefieldTypeValue)a0Value;

            uint a1Mask = 0x0004;
            byte a1Shift = 2;
            uint a1Value = value & a1Mask >> a1Shift;
            ps.ActiveStatus = (Appearance.ActiveStatusValue)a1Value;

            uint a2Mask = 0x0008;
            byte a2Shift = 3;
            uint a2Value = value & a2Mask >> a2Shift;
            ps.Lane = (Appearance.LaneValue)a2Value;

            uint a4Mask = 0x2000;
            byte a4Shift = 13;
            uint a4Value = value & a4Mask >> a4Shift;
            ps.State = (Appearance.StateValue)a4Value;
