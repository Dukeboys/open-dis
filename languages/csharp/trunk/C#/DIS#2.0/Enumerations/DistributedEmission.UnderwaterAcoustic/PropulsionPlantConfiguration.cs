...
namespace OpenDis.Enumerations.DistributedEmission.UnderwaterAcoustic
{
    ...
    public struct PropulsionPlantConfiguration
    {
        ...
        public static PropulsionPlantConfiguration FromUInt32(uint value)
        {
            ...
            ps.Configuration = (PropulsionPlantConfiguration.ConfigurationValue)a0Value;

            uint a1Mask = 0x0080;
            byte a1Shift = 7;
            uint a1Value = value & a1Mask >> a1Shift;
            ps.HullMountedMasker = (PropulsionPlantConfiguration.HullMountedMaskerValue)a1Value;
