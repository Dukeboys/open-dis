...
namespace OpenDis.Enumerations.DistributedEmission.Iff
{
    ...
    public struct Type5Parameter1RRBResponse
    {
        ...
        public static Type5Parameter1RRBResponse FromUInt16(ushort value)
        {
            ...
            ps.Code = (byte)a0Value;

            uint a2Mask = 0x0800;
            byte a2Shift = 11;
            uint a2Value = value & a2Mask >> a2Shift;
            ps.PowerReduction = (Type5Parameter1RRBResponse.PowerReductionValue)a2Value;

            uint a3Mask = 0x1000;
            byte a3Shift = 12;
            uint a3Value = value & a3Mask >> a3Shift;
            ps.RadarEnhancement = (Type5Parameter1RRBResponse.RadarEnhancementValue)a3Value;

            uint a4Mask = 0x2000;
            byte a4Shift = 13;
            uint a4Value = value & a4Mask >> a4Shift;
            ps.Status = (Type5Parameter1RRBResponse.StatusValue)a4Value;

            uint a5Mask = 0x4000;
            byte a5Shift = 14;
            uint a5Value = value & a5Mask >> a5Shift;
            ps.Damage = (Type5Parameter1RRBResponse.DamageValue)a5Value;

            uint a6Mask = 0x8000;
            byte a6Shift = 15;
            uint a6Value = value & a6Mask >> a6Shift;
            ps.Malfunction = (Type5Parameter1RRBResponse.MalfunctionValue)a6Value;
