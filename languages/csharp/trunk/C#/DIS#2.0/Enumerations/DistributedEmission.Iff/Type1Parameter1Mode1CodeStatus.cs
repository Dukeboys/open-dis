...
namespace OpenDis.Enumerations.DistributedEmission.Iff
{
    ...
    public struct Type1Parameter1Mode1CodeStatus
    {
        ...
        public static Type1Parameter1Mode1CodeStatus FromUInt16(ushort value)
        {
            ...
            ps.Status = (Type1Parameter1Mode1CodeStatus.StatusValue)a4Value;

            uint a5Mask = 0x4000;
            byte a5Shift = 14;
            uint a5Value = value & a5Mask >> a5Shift;
            ps.Damage = (Type1Parameter1Mode1CodeStatus.DamageValue)a5Value;

            uint a6Mask = 0x8000;
            byte a6Shift = 15;
            uint a6Value = value & a6Mask >> a6Shift;
            ps.Malfunction = (Type1Parameter1Mode1CodeStatus.MalfunctionValue)a6Value;
