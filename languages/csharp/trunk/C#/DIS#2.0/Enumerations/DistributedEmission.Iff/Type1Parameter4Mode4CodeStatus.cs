...
namespace OpenDis.Enumerations.DistributedEmission.Iff
{
    ...
    public struct Type1Parameter4Mode4CodeStatus
    {
        ...
        public static Type1Parameter4Mode4CodeStatus FromUInt16(ushort value)
        {
            ...
            ps.CodeElement1 = (Type1Parameter4Mode4CodeStatus.CodeElement1Value)a0Value;

            uint a2Mask = 0x2000;
            byte a2Shift = 13;
            uint a2Value = value & a2Mask >> a2Shift;
            ps.Status = (Type1Parameter4Mode4CodeStatus.StatusValue)a2Value;

            uint a3Mask = 0x4000;
            byte a3Shift = 14;
            uint a3Value = value & a3Mask >> a3Shift;
            ps.Damage = (Type1Parameter4Mode4CodeStatus.DamageValue)a3Value;

            uint a4Mask = 0x8000;
            byte a4Shift = 15;
            uint a4Value = value & a4Mask >> a4Shift;
            ps.Malfunction = (Type1Parameter4Mode4CodeStatus.MalfunctionValue)a4Value;
