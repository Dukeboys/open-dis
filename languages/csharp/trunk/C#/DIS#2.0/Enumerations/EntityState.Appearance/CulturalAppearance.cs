...
namespace OpenDis.Enumerations.EntityState.Appearance
{
    ...
    public struct CulturalAppearance
    {
        ...
        public static CulturalAppearance FromUInt32(uint value)
        {
            ...
            ps.Damage = (CulturalAppearance.DamageValue)a1Value;

            uint a2Mask = 0x0060;
            byte a2Shift = 5;
            uint a2Value = value & a2Mask >> a2Shift;
            ps.Smoke = (CulturalAppearance.SmokeValue)a2Value;

            uint a4Mask = 0x8000;
            byte a4Shift = 15;
            uint a4Value = value & a4Mask >> a4Shift;
            ps.Flaming = (CulturalAppearance.FlamingValue)a4Value;

            uint a6Mask = 0x200000;
            byte a6Shift = 21;
            uint a6Value = value & a6Mask >> a6Shift;
            ps.FrozenStatus = (CulturalAppearance.FrozenStatusValue)a6Value;

            uint a7Mask = 0x400000;
            byte a7Shift = 22;
            uint a7Value = value & a7Mask >> a7Shift;
            ps.InternalHeatStatus = (CulturalAppearance.InternalHeatStatusValue)a7Value;

            uint a8Mask = 0x800000;
            byte a8Shift = 23;
            uint a8Value = value & a8Mask >> a8Shift;
            ps.State = (CulturalAppearance.StateValue)a8Value;

            uint a10Mask = 0x10000000;
            byte a10Shift = 28;
            uint a10Value = value & a10Mask >> a10Shift;
            ps.ExteriorLights = (CulturalAppearance.ExteriorLightsValue)a10Value;

            uint a11Mask = 0x20000000;
            byte a11Shift = 29;
            uint a11Value = value & a11Mask >> a11Shift;
            ps.InteriorLights = (CulturalAppearance.InteriorLightsValue)a11Value;

            uint a13Mask = 0x80000000;
            byte a13Shift = 31;
            uint a13Value = value & a13Mask >> a13Shift;
            ps.MaskedCloaked = (CulturalAppearance.MaskedCloakedValue)a13Value;
