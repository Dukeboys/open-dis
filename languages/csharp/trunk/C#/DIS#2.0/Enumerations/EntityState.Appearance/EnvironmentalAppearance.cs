...
namespace OpenDis.Enumerations.EntityState.Appearance
{
    ...
    public struct EnvironmentalAppearance
    {
        ...
        public static EnvironmentalAppearance FromUInt32(uint value)
        {
            ...
            ps.Density = (EnvironmentalAppearance.DensityValue)a1Value;

            uint a3Mask = 0x200000;
            byte a3Shift = 21;
            uint a3Value = value & a3Mask >> a3Shift;
            ps.FrozenStatus = (EnvironmentalAppearance.FrozenStatusValue)a3Value;

            uint a5Mask = 0x800000;
            byte a5Shift = 23;
            uint a5Value = value & a5Mask >> a5Shift;
            ps.State = (EnvironmentalAppearance.StateValue)a5Value;

            uint a7Mask = 0x80000000;
            byte a7Shift = 31;
            uint a7Value = value & a7Mask >> a7Shift;
            ps.MaskedCloaked = (EnvironmentalAppearance.MaskedCloakedValue)a7Value;
