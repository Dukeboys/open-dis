...
patch src/main/edu/nps/moves/dis/Pdu.java patches/java/Pdu.patch

# Marking.java, apply patch file to ensure character fields are exactly 11 bytes long after set operations
patch src/main/edu/nps/moves/dis/Marking.java patches/java/Marking.patch

# Apply patch to VariableDatum.java
patch src/main/edu/nps/moves/dis/VariableDatum.java patches/java/VariableDatum.patch

# Apply patch to EntityID to get equality, hashcode
patch src/main/edu/nps/moves/dis/EntityID.java patches/java/EntityID.patch
...
patch src/main/edu/nps/moves/dis/Vector3Double.java patches/java/Vector3Double.patch
