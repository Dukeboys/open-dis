/** @file Celestiomagnetic.h
@author David Shen
@brief Celestiomagnetic SRF.
*/
...
// $Id: Celestiomagnetic.h,v 1.19 2008/10/21 19:11:10 worleym Exp $

#ifndef _Celestiomagnetic_h
#define _Celestiomagnetic_h
...
namespace srm
{
  ...
  /** SRF_Celestiomagnetic class declaration.
      ...
      @see BaseSRF_3D
  */
  class EXPORT_SRM_CPP_DLL SRF_Celestiomagnetic: public BaseSRF_3D
    {
    public:
...
/** A Coord3D for SRF_Celestiomagnetic.
  ...
  */
class EXPORT_SRM_CPP_DLL Coord3D_Celestiomagnetic: public Coord3D
{
public:
   /** Constructor
    */
