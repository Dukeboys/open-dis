/** @file SolarMagneticEcliptic.h
@author David Shen
@brief SolarMagneticEcliptic SRF.
*/
...
// $Id: SolarMagneticEcliptic.h,v 1.18 2009/10/02 19:30:26 worleym Exp $

#ifndef _SolarMagneticEcliptic_h
#define _SolarMagneticEcliptic_h
...
namespace srm
{
  /** SRF_SolarMagneticEcliptic class declaration.
      ...
      @see BaseSRF_3D
  */
class EXPORT_SRM_CPP_DLL SRF_SolarMagneticEcliptic: public BaseSRF_3D
{
public:
...
*/
class EXPORT_SRM_CPP_DLL Coord3D_SolarMagneticEcliptic: public Coord3D
{
public:
   /** Constructor
    */
