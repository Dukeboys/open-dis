...
// $Id: PolarStereographic.h,v 1.17 2009/10/12 20:23:34 worleym Exp $

#ifndef _PolarStereographic_h
#define _PolarStereographic_h
...
*/
class EXPORT_SRM_CPP_DLL SRF_PolarStereographic: public BaseSRF_MapProjection
{
public:
 ...
 */
class EXPORT_SRM_CPP_DLL Coord3D_PolarStereographic: public Coord3D
{
public:
   /** Constructor
    */
...
/** A CoordSurf for SRF_PolarStereographic.
    ...
    @see SRF_PolarStereographic
 */
class EXPORT_SRM_CPP_DLL CoordSurf_PolarStereographic: public CoordSurf
{
public:
   /** Constructor
    */
