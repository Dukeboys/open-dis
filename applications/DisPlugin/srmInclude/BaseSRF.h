...
// $Id: BaseSRF.h,v 1.63 2009/11/05 21:17:12 worleym Exp $
...
public:
    ...
    */
    ...
    /** This method sets the values of the Orientation object representing the
        orientation of the source srf (at the source reference location) with
        respect to this (the target) srf (at the target reference location).
        The Orientation is computed as the cosine matrix of the source local
        tangent frame (at the source reference location) with respect to the
        target local tangent frame (at the target reference location).
    @note The target reference location must have been created using this SRF.
        @note The output orientation (out_ori) is an instance of the one of the concrete
              subclasses of class Orientation.
        @param src_ref_loc in : the source reference point
        @param tgt_ref_loc in : the target reference point
        @param out_ori out : the orientation whose values are set by this method.
        @exception This method throws srm::Exception
    */
    void computeSRFOrientation( const Coord3D &src_ref_loc,
                                const Coord3D &tgt_ref_loc,
                                Orientation &out_ori );

    /** Computes the parameters corresponding to the local tangent frame
        at the input reference location.
        @param ref_loc in : the reference location
        @param ltf out : the parameters for the local tangent frame, which are
                         the parameters for the Lococentric Euclidean 3D SRF
                         at the reference coordinate
        @exception This method throws srm::Exception
    */
    void getLocalTangentFrameSRFParameters ( const Coord3D &ref_loc,
    ...
    */
    virtual SRF_LococentricEuclidean3D
       *createLococentricEuclidean3DSRF ( const Coord3D &lococentre,
    ...
    /** Given an orientation with respect to a local tangent frame (LTF_S)
        ...
        The SRF invoking this method is the target SRF.
         @param src_ref_loc in : the source reference location (a coordinate in
                                 the source SRF) where the origin of the source
                                 local tangent frame (LTF_S) is located
         @param src_ori in : the source orientation of some linear reference
                             frame with respect to LTF_S
         @param tgt_ref_loc in : the target reference location (a coordinate in
                                 this SRF, the target SRF) where the origin of
                                 the target local tangent frame (LTF_T) is
                                located
        @param tgt_ori out : the target orientation with respect to LTF_T
        @exception This method throws srm::Exception
    */
    void transformOrientation(const Coord3D     &src_ref_loc,
                                    Orientation &src_ori,
                              const Coord3D     &tgt_ref_loc,
                                    Orientation &tgt_ori );
    ...
    /** Given an orientation with respect to a local tangent frame (LTF_S)
        associated with a reference location in the source SRF, this method
        computes the orientation with respect to the local tangent frame (LTF_T)
        associated with the specified reference location in the target SRF.  LTF_S
        and LTF_T have a common origin. The output orientation is computed by
        composing the orientation of LTF_S with respect to LTF_T with the input
        source orientation. The SRF invoking this method is the target SRF.
         @param src_ref_loc in : the source reference location (a coordinate in
                                 the source SRF) where the origin of the source
                                 local tangent frame (LTF_S) is located
         @param src_ori in : the source orientation of some linear reference
                            frame with respect to LTF_S
         @param tgt_ref_loc out : the coordinate of the common reference
                                 location in the target SRF
        @param tgt_ori out : the target orientation with respect to LTF_T
        @return valid region category for the target reference location
        @exception This method throws srm::Exception
    */
    SRM_Coordinate_Valid_Region transformOrientationCommonOrigin
                (const Coord3D     &src_ref_loc,
                       Orientation &src_ori,
                       Coord3D     &tgt_ref_loc,
                       Orientation &tgt_ori );

    /** Given a vector in a body frame (or in general any linear reference
        frame) and given the orientation, src_ori, of the body frame with
        respect to LTF_S, this method computes the vector representation of
        the vector with respect to LTF_T, where LTF_S is the local tangent
        frame associated with the source SRF at the given source reference
        location, and LTF_T is the local tangent frame associated with the
        target SRF at the given target reference location. The output vector
        is computed by applying the composed orientation, from the orientation
        of LTF_S with respect to LTF_T with the source orientation, to the
        source vector. This method is equivalent to applying the orientation
        result from the transformOrientation method to the source vector.  The
        SRF invoking this method is the target SRF.
         @param src_ref_loc in : the source reference location (a coordinate in
                                 the source SRF) where the origin of the source
                                 local tangent frame (LTF_S) is located
         @param src_ori in : the source orientation of some linear reference
                             frame L with respect to LTF_S
        ...
        @exception This method throws srm::Exception
    */
    void transformVectorInBodyFrame( const Coord3D       &src_ref_loc,
                                           Orientation   &src_ori,
    ...
    /** Given a vector in a body frame (or in general any linear reference
        ...
        @exception This method throws srm::Exception
    */
    SRM_Coordinate_Valid_Region transformVectorInBodyFrameCommonOrigin
                (const Coord3D       &src_ref_loc,
                       Orientation   &src_ori,
                 const SRM_Vector_3D &input_vec,
                       Coord3D       &tgt_ref_loc,
    ...
    /** Given a vector in the local tangent frame (LTF_S) associated with a
        reference location in the source SRF, this method computes the vector
        in the local tangent frame (LTF_T) associated with the specified
        reference location in the tangent SRF. The output vector is computed by
        applying the orientation of LTF_S with respect to LTF_T to the source
        vector. The SRF invoking this method is the target SRF.
         @param src_ref_loc in : the source reference location (a coordinate in
                                 the source SRF) where the origin of the source
                                 local tangent frame (LTF_S) is located
        ...
        @exception This method throws srm::Exception
    */
    void transformVector(const Coord3D       &src_ref_loc,
    ...
    /** Given a vector in the local tangent frame (LTF_S) associated with a
        reference location in the source SRF, this method computes the vector
        in the local tangent frame (LTF_T) associated with the specified
        reference location in the target SRF. LTF_S and LTF_T have a common
        origin. The output vector is computed by applying the orientation of
        LTF_S with respect to LTF_T to the source vector. The SRF invoking this
        method is the target SRF.
         @param src_ref_loc in : the source reference location (a coordinate in
                                the source SRF) where the origin of the source
                                local tangent frame (LTF_S) is located
         @param src_vec in : the source vector in LTF_S
         @param tgt_ref_loc out : coordinate of the common reference location in
                                 the target SRF
        @param tgt_vec out : the target vector in LTF_T
        @return valid region category for the target reference location
        @exception This method throws srm::Exception
    */
    SRM_Coordinate_Valid_Region transformVectorCommonOrigin
                (const Coord3D       &src_ref_loc,
                 const SRM_Vector_3D &src_vec,
                       Coord3D       &tgt_ref_loc,
                       SRM_Vector_3D &tgt_vec );
