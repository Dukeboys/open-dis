...
#ifndef _TransverseMercator_h
#define _TransverseMercator_h
 ...
 */
class EXPORT_SRM_CPP_DLL SRF_TransverseMercator: public BaseSRF_MapProjection
{
public:
 ...
 */
class EXPORT_SRM_CPP_DLL Coord3D_TransverseMercator: public Coord3D
{
public:
   /** Constructor
    */
...
/** A CoordSurf for SRF_TransverseMercator.
    ...
    @see SRF_TransverseMercator
 */
class EXPORT_SRM_CPP_DLL CoordSurf_TransverseMercator: public CoordSurf
{
public:
   /** Constructor
    */
