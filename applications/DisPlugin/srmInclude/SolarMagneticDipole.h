/** @file SolarMagneticDipole.h
@author David Shen
@brief SolarMagneticDipole SRF.
*/
...
// $Id: SolarMagneticDipole.h,v 1.18 2009/10/02 19:30:25 worleym Exp $

#ifndef _SolarMagneticDipole_h
#define _SolarMagneticDipole_h
...
/** SRF_SolarMagneticDipole class declaration.
    ...
    @see BaseSRF_3D
 */
class EXPORT_SRM_CPP_DLL SRF_SolarMagneticDipole: public BaseSRF_3D
{
public:
 ...
 */
class EXPORT_SRM_CPP_DLL Coord3D_SolarMagneticDipole: public Coord3D
{
public:
   /** Constructor
    */
