...
/*!
 * STRUCT: SRM_Axis_Angle_Params
 *
 *  This data type represents an orientation in (axis, angle) representation.
 */
typedef struct
{
    SRM_Vector_3D  axis;
...
/*!
 * STRUCT: SRM_Equatorial_Spherical_3D_Coordinate
 *
 *   This type contains the Equatorial Spherical 3D coordinate values.
 */
typedef struct
{
    SRM_Long_Float longitude;
...
/*!
 * GLOBAL CONSTANT: SRM_CSCOD_LOCOCENT_EUCLIDEAN_3D
 *
...
/*!
 * GLOBAL CONSTANT: SRM_CSCOD_EQUATORIAL_SPHERICAL
 *
...
/*!
 * GLOBAL CONSTANT: SRM_CSCOD_LOCOCENT_EQUATORIAL_SPHERICAL
 *
 *  Localized spherical
 */
...
/*!
 * GLOBAL CONSTANT: SRM_CSCOD_LOCOCENT_AZIMUTHAL_SPHERICAL
 *
...
/*!
 * GLOBAL CONSTANT: SRM_CSCOD_LOCOCENT_EUCLIDEAN_2D
 *
...
/*!
 * GLOBAL CONSTANT: SRM_CSCOD_LOCOCENT_AZIMUTHAL
 *
...
/*!
 * STRUCT: SRM_Euler_Angles_ZXZ_Params
 *
 *  This data type represents an orientation in Euler angles (ZXZ)
 *  representation.
 */
typedef struct
{
...
/*!
 * REGISTERABLE ENUM: SRM_Ori_Rep_Type
 *
 *  $$$ This data type indicates the type of representation used by
 *  $$$ an Orientation object. Will be modified - the enumerant
 *  $$$ prefix is non-standard and will change in any case.
 */
typedef SRM_Integer SRM_Ori_Rep_Type;

/*!
 * GLOBAL CONSTANT: SRM_ORI_REP_MATRIX_3X3
 *
 *  The orientation is represented as a matrix 3x3.
 */
#define SRM_ORI_REP_MATRIX_3X3 ((SRM_Ori_Rep_Type)1)

/*!
 * GLOBAL CONSTANT: SRM_ORI_REP_AXIS_ANGLE
 *
 *  The orientation is represented as an axis of rotation and an angle of
 *  rotation.
 */
#define SRM_ORI_REP_AXIS_ANGLE ((SRM_Ori_Rep_Type)2)

/*!
 * GLOBAL CONSTANT: SRM_ORI_REP_EULER_ANGLES_ZXZ
 *
 *  The orientation is represented in Euler angles (ZXZ) representation.
 */
#define SRM_ORI_REP_EULER_ANGLES_ZXZ ((SRM_Ori_Rep_Type)3)

/*!
 * GLOBAL CONSTANT: SRM_ORI_REP_TAIT_BRYAN_ANGLES
 *
 *  The orientation is represented in Tait-Bryan angles (XYZ)
 *  representation.
 */
#define SRM_ORI_REP_TAIT_BRYAN_ANGLES ((SRM_Ori_Rep_Type)4)

/*!
 * GLOBAL CONSTANT: SRM_ORI_REP_QUATERNION
 *
 *  The orientation is represented as a quaternion.
 */
#define SRM_ORI_REP_QUATERNION ((SRM_Ori_Rep_Type)5)


/*! Upper Bound value for Ori_Rep_Types */
#define SRM_ORI_REP_TYPE_UBOUND 5
...
/*!
 * GLOBAL CONSTANT: SRM_ORMCOD_EARTH_INERT_ARIES_1950
 *
...
/*!
 * GLOBAL CONSTANT: SRM_ORMCOD_EARTH_INERT_ARIES_TRUE_OF_DATE
 *
...
/*!
 * GLOBAL CONSTANT: SRM_ORMCOD_HELIO_ARIES_ECLIPT_J2000r0
 *
...
/*!
 * GLOBAL CONSTANT: SRM_ORMCOD_HELIO_ARIES_ECLIPT_TRUE_OF_DATE
 *
...
/*!
 * GLOBAL CONSTANT: SRM_ORMCOD_MODTRAN_MIDLAT_N_1989
 *
 *  MODTRAN
 */
...
/*!
 * GLOBAL CONSTANT: SRM_ORMCOD_MODTRAN_MIDLAT_S_1989
 *
 *  MODTRAN
 */
...
typedef struct
{
    SRM_Long_Float e0;
   /*
    * the scale (real) parameter
    */

    SRM_Long_Float e1;
   /*
    * the vector multiplier in (i) direction
    */

    SRM_Long_Float e2;
   /*
    * the vector multiplier in (j) direction
    */

    SRM_Long_Float e3;
   /*
    * the vector multiplier in (k) direction
    */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_AUSTRALIA_GEOD_1984_3_AUSTRALIA_TASMANIA
 *
 *  Australia and Tasmania
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_AUSTRALIA_GEOD_1984_7_AUSTRALIA_TASMANIA
 *
 *  Australia and Tasmania
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_MARS_SPHERE_2000_IDENTITY_BY_DEFAULT
 *
 *  Global (Mars)
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_OLD_HAWAII_C_1987_HAWAII
 *
 *  Hawaii (US)
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_OLD_HAWAII_C_1987_KAUAI
 *
 *  Kauai (US)
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_OLD_HAWAII_C_1987_MAUI
 *
 *  Maui (US)
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_OLD_HAWAII_C_1987_MEAN_SOLUTION
 *
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_OLD_HAWAII_C_1987_OAHU
 *
 *  Oahu (US)
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_OLD_HAWAII_I_1987_HAWAII
 *
 *  Hawaii (US)
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_OLD_HAWAII_I_1987_KAUAI
 *
 *  Kauai (US)
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_OLD_HAWAII_I_1987_MAUI
 *
 *  Maui (US)
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_OLD_HAWAII_I_1987_MEAN_SOLUTION
 *
 *  Mean Solution (Hawaii (US))
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_OLD_HAWAII_I_1987_OAHU
 *
 *  Oahu (US)
 */
 ...
 *
 *  Mean Solution (England, Isle of Man, Scotland, Shetland Islands, and Wales)
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_S_JTSK_1993_CZECH_REPUBLIC
 *
 *  Czech Republic
 */
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_S_JTSK_1993_CZECH_SLOVAKIA
 *
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_TIMBALAI_EVRST_1948_3_BRUNEI_E_MALAYSIA
 *
...
/*!
 * GLOBAL CONSTANT: SRM_RTCOD_TIMBALAI_EVRST_1948_7_BRUNEI_E_MALAYSIA
 *
...
/*!
 * GLOBAL CONSTANT: SRM_SRFTCOD_LOCAL_SPACE_RECT_3D
 *
...
/*!
 * GLOBAL CONSTANT: SRM_SRFTCOD_LOCAL_TANGENT_SPC_EUCLIDEAN
 *
...
/*!
 * GLOBAL CONSTANT: SRM_SRFTCOD_LOCAL_TANGENT_SPC_AZIMUTHAL_SPHERICAL
 *
...
/*!
 * GLOBAL CONSTANT: SRM_SRFTCOD_LOCAL_TANGENT_SPC_CYLINDRICAL
 *
...
/*!
 * GLOBAL CONSTANT: SRM_SRFTCOD_HELIOSPHER_EARTH_ECLIPTIC
 *
...
/*!
 * GLOBAL CONSTANT: SRM_SRFTCOD_HELIOSPHER_EARTH_EQUATORIAL
 *
...
/*!
 * GLOBAL CONSTANT: SRM_SRFTCOD_LOCAL_SPACE_RECT_2D
 *
...
/*!
 * STRUCT: SRM_Tait_Bryan_Angles_Params
 *
 *  This data type represents an orientation in Tait-Bryan angles (XYZ)
 *  representation.
 */
typedef struct
{
...
/*!
 * TYPEDEF: SRM_Vector_2D
 *
 *   This data type specifies a 2-dimensional vector.
 *   $$$ Type added to support Orientation concepts. Will be
 *   $$$ modified later.
 */
