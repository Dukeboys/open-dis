/** @file HeliosphericAriesEcliptic.h
@author David Shen
@brief HeliosphericAriesEcliptic SRF.
*/
...
// $Id: HeliosphericAriesEcliptic.h,v 1.19 2008/10/21 21:32:20 worleym Exp $

#ifndef _HeliosphericAriesEcliptic_h
#define _HeliosphericAriesEcliptic_h
...
/** SRF_HeliosphericAriesEcliptic class declaration.
    ...
    @see BaseSRF_3D
 */
class EXPORT_SRM_CPP_DLL SRF_HeliosphericAriesEcliptic: public BaseSRF_3D
{
public:
...
typedef SRF_HeliosphericAriesEcliptic SRF_HAEC;
  ...
  */
class EXPORT_SRM_CPP_DLL Coord3D_HeliosphericAriesEcliptic: public Coord3D
{
public:
   /** Constructor
    */
